            ...
            if EntityFreeAim then
                ...
                if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                    ...
                    if IsControlJustReleased(0, 47) then -- Freeze entities
                        ...
                        exports['Ethnic-ui']:Notify('frozen-action', Lang:t("info.you_have")..(FrozenEntities[entity] and Lang:t("info.entity_frozen") or Lang:t("info.entity_unfrozen")).. Lang:t("info.freeaim_entity"), (FrozenEntities[entity] and 'success' or 'error'))
                    end
                    ...
                    if IsControlJustReleased(0, 38) then -- Delete entity
                        ...
                        if not DoesEntityExist(entity) then
                            exports['Ethnic-ui']:Notify('del-action', Lang:t("info.entity_del"), 'success')
                        else
                            exports['Ethnic-ui']:Notify('del-action-err', Lang:t("info.entity_del_error"), 'error')
                        end
                    end
                else
                    FreeAimEntity = nil
