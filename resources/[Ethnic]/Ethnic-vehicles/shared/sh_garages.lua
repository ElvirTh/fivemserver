...
Config.Garages = {
    ['apartment_1'] = {
        ...
        Spots = {
            vector4(-297.85, -990.41, 30.48, 340),
            vector4(-301.24, -989.18, 30.48, 340),
            vector4(-304.62, -987.94, 30.48, 340),
            vector4(-308.0, -986.71, 30.48, 340),
            vector4(-311.48, -985.44, 30.48, 340),
            vector4(-315.05, -984.14, 30.48, 340),
            vector4(-318.4, -982.84, 30.48, 340),
            vector4(-321.86, -981.51, 30.48, 340),
            vector4(-325.42, -980.2, 30.48, 340),
            vector4(-328.9, -978.92, 30.48, 340),
            vector4(-332.37, -977.64, 30.48, 340),
            vector4(-335.65, -976.43, 30.48, 340),
            vector4(-339.22, -975.13, 30.48, 340),
            vector4(-342.76, -973.74, 30.48, 340),
        },
    },
    ['legionsquare_1'] = {
        Blip = { Sprite = 357, Color = 3, Text = "Garage" },
    ...
    ['gov_sdso'] = {
        Zone = { vector3(1829.96, 3688.12, 33.97), 5.0, 5.0, 300, 32.97, 36.97 },
        Spots = {
    ...
    ['tommyt_house'] = {
        Zone = { vector3(-408.68, 3032.44, 30.21), 7, 5.0, 215, 29.2, 32.5 },
        Spots = {
            vector4(-408.38, 3031.7, 30.21, 33.29),
        },
    },
}
