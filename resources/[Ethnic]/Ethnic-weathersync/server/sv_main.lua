...
Citizen.CreateThread(function() 
    ...
    CallbackModule.CreateCallback('Ethnic-weathersync/server/get-data', function(Source, Cb)
        Cb(Config.SyncData)
    end)
    ...
    CommandsModule.Add("settime", "Set Time", {{Name="Hour", Help="Hour"}, {Name="Minute", Help="Minute"}}, false, function(source, args)
        ...
        if Minutes <= 60 and Hour < 24 then
            ...
            TriggerClientEvent('Ethnic-weathersync/client/sync', -1, Config.SyncData)
    ...
    EventsModule.RegisterServer("Ethnic-weathersync/server/set-blackout", function(Source)
...
Citizen.CreateThread(function()
    while true do
        ...
        if Config.Syncing and not Config.Frozen then
            ...
            TriggerClientEvent('Ethnic-weathersync/client/sync', -1, Config)
