...
--[[
    ...
    (Full bonelist: Ethnic-ui/bonelist.md)
        ...
        Options = {
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-vehicles/client/fuel/refuel-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if exports['Ethnic-vehicles']:IsElectricVehicle(Entity) then
                    ...
                    if exports['Ethnic-vehicles']:CanRefuel() then
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-police/client/scan-plate',
                EventParams = {},
                Enabled = function(Entity)
            ...
            },
            {
                ...
                Icon = 'fas fa-redo',
                EventType = 'Client',
                EventName = 'Ethnic-vehicles/client/try-flip-vehicle',
                EventParams = {},
                Enabled = function(Entity)
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-business/client/hayes/check-vehicle',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['Ethnic-business']:IsHayes()
                end,
            },
            {
                Name = 'close_trunk',
                ...
                EventType = 'Client',
                EventName = 'Ethnic-vehicles/client/toggle-door-data',
                EventParams = {
                    IsMenu = false,
                    DoorNumber = 5,
                },
            ...
            },
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-vehicles/client/get-in-trunk',
                EventParams = {},
                Enabled = function(Entity)
                    return ((GetBoneDistanceFromVehicle(2, "boot") < 1.20) and (GetVehicleDoorAngleRatio(Entity, 5) > 0.0))
                end,
            },
            {
                ...
                Icon = 'fas fa-spinner',
                EventType = 'Client',
                EventName = 'Ethnic-vehicles/client/carry-bicycle',
                EventParams = {},
                Enabled = function(Entity)
            ...
            -- Oxy
            {
                ...
                Icon = 'fas fa-cubes',
                EventType = 'Client',
                EventName = 'Ethnic-jobs/client/oxy/deliver-goods',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['Ethnic-phone']:IsJobCenterTaskActive('oxy', 4) and not exports['Ethnic-phone']:IsJobCenterTaskActive('oxy', 6) then return false end

                    if Entity == exports['Ethnic-jobs']:GetOxyVehicle() then
                        return true
                    else
                        return false
                    end
            ...
            -- Sanitation
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-jobs/client/sanitation/throw-in-trash',
                EventParams = {},
                Enabled = function(Entity)
            ...
            },
            {
                ...
                Icon = 'fas fa-circle',
                EventType = 'Client',
                EventName = 'Ethnic-jobs/client/sanitation/return-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['Ethnic-phone']:IsJobCenterTaskActive('sanitation', 7) then return false end
            ...
            -- Delivery
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-jobs/client/delivery/grab-goods',
                EventParams = {},
                Enabled = function(Entity)
                    if GetEntityModel(Entity) == GetHashKey("benson") and exports['Ethnic-phone']:IsJobCenterTaskActive('delivery', 4) then
                        return true
                    else
                        return false
                    end
            ...
            },
            {
                ...
                Icon = 'fas fa-circle',
                EventType = 'Client',
                EventName = 'Ethnic-jobs/client/delivery/return-veh',
                EventParams = {},
                Enabled = function(Entity)
                    if not exports['Ethnic-phone']:IsJobCenterTaskActive('delivery', 5) then return false end
        ...
        Options = {
            {
                ...
                Icon = 'fas fa-anchor',
                EventType = 'Client',
                EventName = 'Ethnic-items/client/use-anchor-lower',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['Ethnic-items']:CanDropAnchor()
                end,
            },
            {
                Name = 'anchor-up',
                ...
                Icon = 'fas fa-anchor',
                EventType = 'Client',
                EventName = 'Ethnic-items/client/use-anchor-raise',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['Ethnic-items']:CanTiltAnchor()
                end,
            },
        ...
        Options = {
            {
                ...
                Icon = 'fas fa-gas-pump',
                EventType = 'Server',
                EventName = 'Ethnic-vehicles/server/refuel-helicopter',
                EventParams = {},
                Enabled = function(Entity)
                    return exports['Ethnic-vehicles']:CanRefuelAircraft(Entity)
                end,
            },
        }
    },
        ...
        Options = {
            {
                ...
                EventType = 'Client',
                EventName = 'Ethnic-police/client/search-closest',
                EventParams = {},
                Enabled = function(Entity)
