...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-heists/server/stores/register-robbable', function(Source, Cb, RegisterId)
    ...
    EventsModule.RegisterServer("Ethnic-heists/server/stores/receive-money", function(Source)    
...
RegisterNetEvent("Ethnic-heists/server/stores/set-state", function(RegisterId, Type, Bool)
