    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://Ethnic-phone/Employment/SetEmployeeRank", JSON.stringify({
    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post('https://Ethnic-phone/Employment/PayExternal', JSON.stringify({
                    BusinessName: CurrentBusinessData.name,
                    Result: Result,
                }), function(Result){
                    SetPhoneLoader(false);
    ...
    DoPhoneText('Are you sure you want to fire this person?', [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://Ethnic-phone/Employment/RemoveEmployee", JSON.stringify({
                    BusinessName: CurrentBusinessData.name,
            ...
            Callback: () => {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            $('.phone-input-wrapper').hide();
                            $.post("https://Ethnic-phone/Employment/AddEmployee", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result
                            }), function(Result){
                                if (Result.Success){
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://Ethnic-phone/Employment/ChargeCustomer", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://Ethnic-phone/Employment/CreateRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://Ethnic-phone/Employment/EditRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
                ...
                [
                    ...
                    },
                    {
                        ...
                        Callback: (Result) => {
                            ...
                            $.post("https://Ethnic-phone/Employment/RemoveRank", JSON.stringify({
                                BusinessName: CurrentBusinessData.name,
                                Result: Result,
                            }), function(Success){
                                if (Success) {
...
var RefreshBusinessData = () => {
    $.post("https://Ethnic-phone/Employment/GetSpecificBusiness", JSON.stringify({
