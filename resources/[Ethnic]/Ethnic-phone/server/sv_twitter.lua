...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/twitter/get-tweets', function(Source, Cb)
    ...
    EventsModule.RegisterServer("Ethnic-phone/server/twitter-post", function(Source, Data)
        ...
        DatabaseModule.Insert('INSERT INTO player_phone_tweets (CitizenId, Tweeter, Message, Time, IsBusiness) VALUES (?, ?, ?, ?, ?) ', {
            ...
            if IsSent then
                ...
                TriggerClientEvent('Ethnic-phone/client/twitter/sync-tweets', -1, Tweet)
