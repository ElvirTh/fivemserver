...
AddEventHandler('Modules/client/ready', function()
    TriggerEvent('Modules/client/request-dependencies', {
        ...
        ThreadsModule = exports['Ethnic-base']:FetchModule('Threads')
        _Ready = true
    end)
end)
...
RegisterCommand("ui-r", function()
    TriggerEvent("Ethnic-ui/client/ui-reset")
end)
...
RegisterNetEvent('Ethnic-ui/client/notify', function(id, message, type, duration)
    SendUIMessage("Prompts", "CreatePrompt", {
        text = message,
        color = type,
        duration = duration,
...
RegisterNetEvent('Ethnic-ui/client/CopyToClipboard', function(Text)
...
function SendUIMessage(app, action, data)
    --[[
        if app == 'Phone' then
            ...
            exports['Ethnic-base']:DebugTable(data)
        end
    ]]
    SendNUIMessage({
        app = app,
