...
function BuildMenu(Vehicle)
    ...
    if BodyHealth < 1000.0 then
        ...
        for i = 1, #Config.Menus, 1 do
            ...
            -- local VehicleRecord = CallbackModule.SendCallback("Ethnic-police/server/getVehicleRecord", GetVehicleNumberPlateText(Vehicle))
            ...
            if exports['Ethnic-vehicles']:IsGovVehicle(Vehicle) and Data.Disabled.Emergency then goto Skip end
...
function BuildFitmentMenu(Vehicle)
    ...
    Citizen.CreateThread(function()
        ...
        exports['Ethnic-vehicles']:SetVehicleMeta(Vehicle, "WheelFitment", {
