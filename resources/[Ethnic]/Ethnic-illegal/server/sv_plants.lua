...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-illegal/server/get-plants', function(Source, Cb)
    ...
    EventsModule.RegisterServer("Ethnic-illegal/server/plants-plant", function(Source, Coords)
        ...
        TriggerClientEvent('Ethnic-illegal/client/plants-action', -1, 2, Config.WeedPlants[NewId])
    end)
end)
...
Citizen.CreateThread(function()
    Citizen.SetTimeout(750, function()
        while true do
            ...
            TriggerClientEvent('Ethnic-illegal/client/plants-action', -1, 1, UpdatedPlants)
...
RegisterNetEvent("Ethnic-illegal/server/do-plant-stuff", function(Type, PlantId, Amount)
    local src = source
    ...
    if Type == 'Harvest' then
        Plant.Stage = 0
        TriggerClientEvent('Ethnic-illegal/client/plants-action', -1, 3, Plant)
    ...
    elseif Type == 'Destroy' then
        ...
        TriggerClientEvent('Ethnic-illegal/client/plants-action', -1, 4, Plant)
