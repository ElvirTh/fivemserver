...
$(document).on({
    mouseenter: function(e){
        ...
        $.post('https://Ethnic-ui/Characters/GetCharacterNameByCid', JSON.stringify({
            Cid: Cid
        }), (Name) => {
            if (Name) {
...
$(document).on('click', '.char-options-play', function(e){
    ...
    $.post("https://Ethnic-ui/Characters/LoadCharacter", JSON.stringify({
        Cid: Cid,
    }))
});
...
$(document).on('dblclick', '.characters-item', function(e){
    ...
    $.post('https://Ethnic-ui/Characters/GetCharacterNameByCid', JSON.stringify({
        ...
        if (Name) {
            ...
            // $.post("https://Ethnic-ui/Characters/GetFirstEmptyCid", JSON.stringify({}), function(Cid){
            //     if (Cid == false) {
...
$(document).on('click', '.character-delete-button-confirm', function(e){
    ...
    ResetMenu();
    $.post("https://Ethnic-ui/Characters/DeleteCharacter", JSON.stringify({
        Cid: Cid,
    }))
...
$(document).on('click', '.character-create-button-create', function(e){
    ...
    ResetMenu();
    // Create Character
    $.post("https://Ethnic-ui/Characters/CreateCharacter", JSON.stringify({
        Cid: Cid,
        Firstname: FirstName,
        Lastname: LastName,
        Birthdate: BirthDate,
...
$(document).on('click', '.character-create-refresh', function(e){
    $('.character-options').show();
    ResetMenu();
    $.post("https://Ethnic-ui/Characters/Refresh", JSON.stringify({}));
});
