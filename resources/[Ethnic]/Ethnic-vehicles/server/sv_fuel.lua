...
CreateThread(function() 
    ...
    CallbackModule.CreateCallback('Ethnic-vehicles/server/fuel/is-bill-paid', function(Source, Cb, Plate)
...
RegisterNetEvent("Ethnic-vehicles/server/fuel/send-bill", function(Plate, Cid, Amount, IsElectric)
    local src = source
        ...
        Buttons = {
            {
                ...
                Event = "Ethnic-vehicles/server/fuel/decline-pay-request",
                EventType = "Server",
                EventData = {
                    ['NotifId'] = NotifId,
                },
            ...
            },
            {
                ...
                Event = "Ethnic-vehicles/server/fuel/accept-pay-request",
                EventType = "Server",
                EventData = {
                    ['NotifId'] = NotifId,
...
RegisterNetEvent("Ethnic-vehicles/server/fuel/set-paid-state", function(Plate)
    local src = source
    local Player = PlayerModule.GetPlayerBySource(src)
    PaidForFuel[Plate] = false
end)

RegisterNetEvent("Ethnic-vehicles/server/fuel/accept-pay-request", function(Data)
    local Player = PlayerModule.GetPlayerBySource(Data.Source)
    TriggerClientEvent('Ethnic-phone/client/hide-notification', Data.Source, Data['NotifId'])
    if Player then
...
RegisterNetEvent("Ethnic-vehicles/server/fuel/decline-pay-request", function(Data)
    TriggerClientEvent('Ethnic-phone/client/hide-notification', Data.Source, Data['NotifId'])
end)