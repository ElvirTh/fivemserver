    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                SetPhoneLoader(true);
                $.post("https://Ethnic-phone/Contacts/AddContact", JSON.stringify({
                    Data: Result,
                }), function(){           
                    $.post("https://Ethnic-phone/Contacts/GetContacts", JSON.stringify({}), function(Result){
...
$(document).on('click', '.phone-contacts-item #phone-contact-delete', function(e){
    ...
    $.post("https://Ethnic-phone/Contacts/RemoveContact", JSON.stringify({
        ContactId: ContactId,
    }), function(){
        ShowPhoneCheckmark();
    });
...
$(document).on('click', '.phone-contacts-item #phone-contact-call', function(e){
    ...
    $.post("https://Ethnic-phone/Contacts/CallContact", JSON.stringify({
    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://Ethnic-phone/Messages/SendMessage", JSON.stringify({
                    ContactData: ContactData,
