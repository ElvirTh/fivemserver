...
RegisterNetEvent("Ethnic-items/client/used/gold-pan", function(Item)
    ...
    local Result = exports['Ethnic-ui']:StartSkillTest(PanConfigs[Item.ItemName].Streak, { 10, 25 }, { 1500, 4500 }, false)
    ...
    EventsModule.TriggerServer('Ethnic-inventory/server/degen-item', Item.Slot, 2)
    ...
    Citizen.Wait(800)
    exports['Ethnic-assets']:AttachProp("GoldPan")
    Citizen.Wait(7000)
    StopAnimTask(PlayerPedId(), AnimDict, AnimName, 1.0)
    exports['Ethnic-assets']:RemoveProps()
    EventsModule.TriggerServer("Ethnic-misc/server/goldpanning/get-loot", PanConfigs[Item.ItemName].Multiplier)
end)