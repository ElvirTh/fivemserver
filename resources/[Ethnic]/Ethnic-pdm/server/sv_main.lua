...
Citizen.CreateThread(function() 
    ...
    EventsModule.RegisterServer("Ethnic-pdm/server/buy-bicycle", function(Source, BikeData)
        ...
        if Player.Functions.RemoveMoney("Bank", FunctionsModule.GetTaxPrice(BikeData['Price'], 'Vehicle'), "bike-shop") then
            ...
            TriggerClientEvent('Ethnic-pdm/client/bought-bicycle', Source, BikeData['Vehicle'], Plate)
    ...
    EventsModule.RegisterServer("Ethnic-pdm/server/buy-vehicle", function(Source, Model)
        local Player = PlayerModule.GetPlayerBySource(Source)
        ...
        if VehicleData ~= nil then
            if Player.Functions.RemoveMoney("Bank", FunctionsModule.GetTaxPrice(VehicleData['Price'], 'Vehicle'), "vehicle-shop") then
                ...
                TriggerClientEvent('Ethnic-pdm/client/bought-vehicle', Source, VehicleData['Vehicle'], Plate)
