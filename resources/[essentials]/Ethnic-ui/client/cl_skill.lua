...
function StartSkillTest(NeededStreak, SkillGap, ReqSpeed, Reverse)
    ...
    RequestStreamedTextureDict("Ethnic_sprites")
...
function BuildSkillTest(NeededStreak, SkillGap, ReqSpeed, Reverse, Callback)
    ...
    RequestStreamedTextureDict("Ethnic_sprites")
    while not HasStreamedTextureDictLoaded("Ethnic_sprites") do
        Citizen.Wait(0)
    end
    ...
    while DoingTask do
        ...
        DrawSprite("Ethnic_sprites", "circle_128", OriginX, OriginY + (SpriteH / 3), SpriteW, SpriteH, 0, Colors.BgColor.Red, Colors.BgColor.Green, Colors.BgColor.Blue, 255)
        SetScriptGfxDrawOrder(9)

        DrawSprite("Ethnic_sprites", SkillToSprite(SkillGapSent), OriginX, OriginY + (SpriteH / 3.0), SpriteW, SpriteH, TargetRotation, Colors.HudColor.Red, Colors.HudColor.Green, Colors.HudColor.Blue, 255)
        SetScriptGfxDrawOrder(8)

        DrawSprite("Ethnic_sprites", "cursor_128", OriginX, OriginY + (SpriteH / 3), SpriteW, SpriteH, CursorRot, Colors.CursorColor.Red, Colors.CursorColor.Green, Colors.CursorColor.Blue, 255)
    ...
    Citizen.SetTimeout(500, function()
        if not DoingTask then
            SetStreamedTextureDictAsNoLongerNeeded('Ethnic_sprites')
        end
    end)
