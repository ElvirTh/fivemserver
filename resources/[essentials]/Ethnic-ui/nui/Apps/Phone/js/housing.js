...
$(document).on('click', '.phone-housing-nearby-search', function(e){
    ...
    $.post("https://Ethnic-phone/Housing/SearchCurrentLocation", JSON.stringify({}), function(House){
        ...
        if (House) {
            if (House.ForSale) {
                Buttons.unshift({
                    ...
                    Callback: () => {
                        SetPhoneLoader(true);
                        $.post("https://Ethnic-phone/Housing/PurchaseHousing", JSON.stringify({
                            House: House
                        }), function(Success){
                            SetPhoneLoader(false);
                            if (Success) {
...
$(document).on("click", "#phone-housing-setGps", function(e){
    ...
    $.post('https://Ethnic-phone/Housing/Locate', JSON.stringify({ HouseId: HouseId }));
});
...
$(document).on("click", "#phone-housing-lock", function(e){
    ...
    $.post('https://Ethnic-phone/Housing/ToggleLock', JSON.stringify({ HouseId: HouseId }), function(NewState){
        if (NewState) {
...
$(document).on("click", "#phone-housing-sell", function(e){
    ...
    DoPhoneText('Are you sure you want to sell this house?', [
        ...
        },
        {
            ...
            Callback: (Result) => {
                $('.phone-text-wrapper').hide();
                $.post('https://Ethnic-phone/Housing/SellHouse', JSON.stringify({ HouseId: HouseId }), function(Result){
                    if (Result.Success) {
                        ShowPhoneCheckmark();
                    } else {
...
$(document).on("click", ".phone-housing-keys-add-submit", function(e){
    ...
    SetPhoneLoader(true);
    $.post("https://Ethnic-phone/Housing/AddKey", JSON.stringify({
        StateId: StateId,
...
$(document).on("click", ".phone-housing-keys-remove-input", function(e){
    ...
    $.post("https://Ethnic-phone/Housing/GetKeyholders", JSON.stringify({
        HouseId: CurrentHouseKeyEdit,
    }), function(Keyholders){
        var Retval = [];
...
$(document).on("click", ".phone-housing-keys-remove-submit", function(e){
    ...
    SetPhoneLoader(true);
    $.post("https://Ethnic-phone/Housing/RemoveKey", JSON.stringify({
...
//     $.post("https://Ethnic-phone/Housing/SetHouseLocation", JSON.stringify({
//         Location: "Garage",
...
$(document).on("click", '#housing-open-furniture', function(e){
    ...
    $.post("https://Ethnic-phone/Housing/OpenFurniture", JSON.stringify({
        HouseId: PhoneData.HouseCurrentEdit,
    }));
});
...
$(document).on("click", '#housing-delete-furniture', function(e){
    ...
    $.post("https://Ethnic-phone/Housing/DeleteFurniture");
});
