...
RegisterNetEvent('Ethnic-ui/client/ui-reset', function()
    ...
    exports['Ethnic-ui']:SendUIMessage('Pdm', 'Hide')
...
RegisterNetEvent('Ethnic-pdm/client/open-pdm-catalog', function()
    exports['Ethnic-assets']:AttachProp('Laplet')
    exports['Ethnic-ui']:SendUIMessage('Pdm', 'OpenCatalog', {Vehicles = Shared.Vehicles})
...
RegisterNetEvent('Ethnic-pdm/client/bought-vehicle', function(Model, Plate)
    ...
    if ModelLoaded then
        ...
        if Vehicle ~= nil then
            Citizen.SetTimeout(450, function()
                TriggerServerEvent("Ethnic-business/server/hayes/load-parts", Plate, { Engine = 100, Body = 100, Fuel = 100, Axle = 100, Transmission = 100, FuelInjectors = 100, Clutch = 100, Brakes = 100 })
...
RegisterNUICallback('PDM/BuyVehicle', function(Data, Cb)
    EventsModule.TriggerServer('Ethnic-pdm/server/buy-vehicle', Data.Model)
    Cb('Ok')
end)
