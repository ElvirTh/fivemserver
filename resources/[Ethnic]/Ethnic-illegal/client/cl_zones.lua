...
function InitZones()
    Citizen.CreateThread(function()
        ...
        exports['Ethnic-ui']:AddEyeEntry(GetHashKey("gr_prop_gr_bench_04b"), {
            Type = 'Model',
            ...
            Options = {
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-illegal/client/open-crafting-bench',
                    EventParams = '',
                    Enabled = function(Entity)
                        if exports['Ethnic-illegal']:IsInsideBenchContainer() then
                            return true
                        end
                    end,
                },
        ...
        exports['Ethnic-ui']:AddEyeEntry("illegal-sells", {
            Type = 'Entity',
            EntityType = 'Ped',
            SpriteDistance = 10.0,
            Distance = 5.0,
            ...
            Options = {
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-illegal/client/sell-something',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("weed-dry-rack", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Dry Rack',
                    EventType = 'Client',
                    EventName = 'Ethnic-illegal/client/open-dry-rack',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
                },
                {
                    ...
                    EventType = 'Server',
                    EventName = 'Ethnic-illegal/server/start-dry-process',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("illegal-store", {
            Type = 'Entity',
            EntityType = 'Ped',
            SpriteDistance = 5.0,
            Distance = 5.0,
            ...
            Options = {
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-illegal/client/open-pickup-store',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
                ...
                Options = {
                    {
                        ...
                        Label = 'Pick Plant',
                        EventType = 'Client',
                        EventName = 'Ethnic-illegal/client/plants-pick-plant',
                        EventParams = '',
                        Enabled = function(Entity)
                            if exports['Ethnic-illegal']:IsPlantPickable(Entity) then
                                return true
                            else
                                return false
                            end
                    ...
                    },
                    {
                        ...
                        Label = 'Check Plant',
                        EventType = 'Client',
                        EventName = 'Ethnic-illegal/client/plants-open-context',
                        EventParams = '',
                        Enabled = function(Entity)
                            return true
                        end,
                    },
                    {
                        ...
                        Label = 'Destroy Plant',
                        EventType = 'Client',
                        EventName = 'Ethnic-illegal/client/plants-destroy',
                        EventParams = '',
                        Enabled = function(Entity)
        ...
        for k, v in pairs(Config.SellingList) do
            exports["Ethnic-ui"]:AddEyeEntry(v['Ped']['Id'], {
                Type = "Entity",
                EntityType = "Ped",
