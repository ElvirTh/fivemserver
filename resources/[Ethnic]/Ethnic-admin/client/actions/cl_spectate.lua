...
function Spectate.Toggle(TargetSource)
    ...
    if TargetSource == GetPlayerServerId(PlayerId()) then 
        IsSpectating = false 
        exports['Ethnic-ui']:Notify('spectate-self', 'You can\'t spectate yourself!', 'error')
        return 
    end
    ...
    exports['Ethnic-ui']:Notify('spectate-toggled', 'Enabled spectate..', 'success')
    Citizen.CreateThread(function()
        ...
        exports['Ethnic-ui']:Notify('spectate-toggled', 'Disabled spectate..', 'error')
    end)
end