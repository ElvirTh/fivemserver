...
AddEventHandler('playerConnecting', function(playerName, setKickReason, deferrals)
	...
	Wait(750)
	deferrals.update("\n\nWelcome to the Ethnic Framework! Please have a moment, we're loading everything in!")
    Wait(1000)
...
AddEventHandler('playerDropped', function(Reason) 
	local src = source
	TriggerClientEvent('Ethnic-base/client/on-logout', src)
...
RegisterNetEvent("Ethnic-base/server/load-user", function()
	local src = source
