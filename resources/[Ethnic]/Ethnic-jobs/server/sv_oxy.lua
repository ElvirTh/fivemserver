...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-jobs/server/oxy/get-pos', function(Source, Cb, Type)
        Cb(ServerConfig.OxyPositions[Type])
    end)
    
    CallbackModule.CreateCallback('Ethnic-jobs/server/oxy/get-random-oxy-loc', function(Source, Cb, Leader)
    ...
    CallbackModule.CreateCallback('Ethnic-jobs/server/oxy/can-deliver-package', function(Source, Cb, NetId)
    ...
    EventsModule.RegisterServer("Ethnic-jobs/server/oxy/spawn-oxy", function(Source)
        ...
        TriggerClientEvent('Ethnic-jobs/client/oxy/set-veh-data', -1, OxyNetId, false)
        TriggerClientEvent('Ethnic-jobs/client/oxy/veh-drive-to-coord', -1, OxyNetId, DriveCoords)
    end)
    
    EventsModule.RegisterServer("Ethnic-jobs/server/oxy/get-reward", function(Source, NetId)
        ...
        if Player.Functions.RemoveItem('darkmarketpackage', 1, false, true) then
            ...
            TriggerClientEvent('Ethnic-jobs/client/oxy/set-veh-data', -1, nil, true)
