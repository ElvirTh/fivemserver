...
RegisterNetEvent('Ethnic-doors/client/open-elevator-menu', function(Data, Entity)
    if Config.Elevators[Data.ElevatorId] ~= nil then
        ...
        for k, v in pairs(Config.Elevators[Data.ElevatorId]) do                                                                                         
            ...
            MenuData['Data'] = { ['Event'] = 'Ethnic-doors/client/use-elevator', ['Type'] = 'Client', ['CurrentElevator'] = Data, ['ElevatorData'] = v }
...
RegisterNetEvent('Ethnic-doors/client/use-elevator', function(Data)
    if Data.ElevatorData.Coords ~= nil then
        exports['Ethnic-ui']:ProgressBar('Waiting for elevator..', 3500, {['AnimName'] = 'idle_a', ['AnimDict'] = 'amb@world_human_hang_out_street@female_hold_arm@idle_a', ['AnimFlag'] = 8}, false, true, true, function(DidComplete)
            if DidComplete then
    ...
    Citizen.CreateThread(function()
        for k, v in pairs(Config.ElevatorZones) do
            for Elevator, ElevatorData in pairs(Config.ElevatorZones[k]) do
                exports['Ethnic-ui']:AddEyeEntry("elevator_"..k..'-'..Elevator, {
                    Type = 'Zone',
                    SpriteDistance = 5.0,
                    Distance = 4.0,
                    ZoneData = {
                    ...
                    Options = {
                        {
                            ...
                            Label = 'Elevator',
                            EventType = 'Client',
                            EventName = 'Ethnic-doors/client/open-elevator-menu',
...
function ElevatorToCoords(FromElevatorId, ToElevatorId, Coords)
    ...
    TriggerEvent('Ethnic-doors/client/on-elevator-leave', FromElevatorId)
    TriggerEvent('Ethnic-ui/client/play-sound', 'elevator', 0.2)
    ...
    TriggerEvent('Ethnic-doors/client/on-elevator-enter', ToElevatorId)
    SetEntityCoords(PlayerPedId(), Coords.x + 0.0, Coords.y + 0.0, Coords.z + 0.0)
...
-- AddEventHandler('Ethnic-doors/client/on-elevator-enter', function(Entering)
--     print('Entering..', Entering)
-- end)

-- AddEventHandler('Ethnic-doors/client/on-elevator-leave', function(Leaving)
