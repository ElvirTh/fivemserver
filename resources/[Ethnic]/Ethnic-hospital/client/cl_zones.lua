...
function InitHospitalZones()
    Citizen.CreateThread(function()
        exports['Ethnic-ui']:AddEyeEntry("medic_sign_in", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("medic_scanner", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 2.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Blood Scanner',
                    EventType = 'Client',
                    EventName = 'Ethnic-hospital/client/scan-blood',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
        ...
        exports['Ethnic-ui']:AddEyeEntry("medic_locker", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 2.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'EMS Locker',
                    EventType = 'Client',
                    EventName = 'Ethnic-hospital/client/open-ems-store',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'ems' and Player.Job.Duty then
    ...
    if PolyData.name == 'hospital_check_in' then
        if not NearCheckIn then
            ...
            if not ShowingInteraction then
                ...
                exports['Ethnic-ui']:SetInteraction('[E] Check-In', 'primary')
            end
            Citizen.CreateThread(function()
                while NearCheckIn do
                    ...
                    if IsControlJustReleased(0, 38) then
                        ...
                        TriggerEvent('Ethnic-hospital/client/try-send-to-bed', false)
                    end
                end
            end)
        end
