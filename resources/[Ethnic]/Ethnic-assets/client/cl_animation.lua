...
RegisterNetEvent('Ethnic-assets/client/set-my-walkstyle', function()
...
RegisterNetEvent('Ethnic-assets/client/play-call-animation', function()
...
RegisterNetEvent('Ethnic-assets/client/play-door-animation', function()
...
RegisterNetEvent('Ethnic-assets/client/play-cash-animation', function()
    if not IsPedInAnyVehicle(PlayerPedId()) then
...
RegisterNetEvent('Ethnic-assets/client/dice-animation', function()
    if not IsPedInAnyVehicle(PlayerPedId()) then
...
RegisterNetEvent('Ethnic-assets/client/lockpick-animation', function(Bool)
    Lockpicking = Bool
...
RegisterNetEvent('Ethnic-assets/client/heal-animation', function(Bool)
    Healing = Bool
...
RegisterNetEvent('Ethnic-assets/client/animation-tackle', function()
...
RegisterNetEvent('Ethnic-assets/client/get-tackled', function()
...
function TryTackle()
    if not TimerEnabled then
        ...
        if ClosestPlayer['ClosestPlayerPed'] ~= -1 and ClosestPlayer['ClosestServer'] ~= -1 then
            ...
            if Diff < 40 then
                TimerEnabled = true
                TriggerServerEvent('Ethnic-assets/server/tackle-player', ClosestPlayer['ClosestServer'])
                TriggerEvent("Ethnic-assets/client/animation-tackle")
