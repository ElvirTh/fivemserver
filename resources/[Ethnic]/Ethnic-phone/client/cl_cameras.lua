...
function Cameras.Render()
    exports['Ethnic-ui']:SendUIMessage("Phone", "RenderCamerasApp", {
...
RegisterNUICallback("Cameras/AddCamera", function(Data, Cb)
    ...
    local CamData = CallbackModule.SendCallback("Ethnic-misc/server/gopros/does-exist", Data.CamId)
...
RegisterNUICallback("Cameras/ViewCamera", function(Data, Cb)
    TriggerEvent("Ethnic-misc/client/gopros/view-camera", Data)
    Cb('Ok')
end)
