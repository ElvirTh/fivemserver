...
CloseDispatch = function() {
    ...
    $('.tooltip-css').remove();
    $.post('https://Ethnic-ui/Police/CloseDispatch', JSON.stringify({}));
}
...
OpenDispatch = function() {
    if (!DispatchOpen) {
        ...
        $.post('https://Ethnic-ui/Police/GetOnDutyPeople', JSON.stringify({}), function(Data) {
            if (Data != undefined && Data != null) {
                // $.post('https://Ethnic-ui/Police/GetDispatchData', JSON.stringify({}), function(DispatchData) {
...
$(".duty-card-person").on("contextmenu", function(e) {
    ...
    // let DropDownItems = []
    // $.post('https://Ethnic-ui/Police/GetDispatchData', JSON.stringify({}), function(Data) {
    //     if (Data != undefined && Data != null) {
...
$(document).on('click', '.police-alert-marker', function(e) {
    ...
    $.post('https://Ethnic-ui/Police/SetWaypoint', JSON.stringify({Coords: Coords}));
});
