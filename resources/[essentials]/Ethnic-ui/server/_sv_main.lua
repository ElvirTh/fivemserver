...
Citizen.CreateThread(function() 
    ...
    CallbackModule.CreateCallback('Ethnic-ui/server/police/get-duty-people', function(source, Cb)
        local PoliceInDuty = {}
    ...
    CallbackModule.CreateCallback('Ethnic-ui/server/characters-get', function(source, Cb)
    ...
    CallbackModule.CreateCallback('Ethnic-ui/server/characters/get-skin', function(Source, Cb, Cid)
        local Steam = FunctionsModule.GetIdentifier(Source, "steam")
        local SkinData = {
            ['Model'] = nil,
            ['Tattoos'] = nil,
    ...
    CallbackModule.CreateCallback('Ethnic-ui/server/characters/get-character-name-by-cid', function(source, Cb, Cid)
        local CharInfo = {}
    ...
    CallbackModule.CreateCallback('Ethnic-ui/server/characters/get-first-empty-cid', function(Source, Cb)
        local Cid = PlayerModule.GetAvailableCharId(Source)
        Cb(Cid)
    end)

    CallbackModule.CreateCallback('Ethnic-houses/server/get-houses-keyholder', function(source, Cb, CitizenId)
        local HouseDatas = {}
    ...
    CommandsModule.Add("hud", "Change your preferences", {}, false, function(source, args)
        local Bool = not Bool
        TriggerClientEvent('Ethnic-ui/client/preferences/toggle-visibility', source, Bool)
    end)

    CommandsModule.Add("cash", "Show your current cash amount", {}, false, function(source, args)
        TriggerClientEvent('Ethnic-ui/client/show-cash', source)
    end)

    CommandsModule.Add("job", "Show your current job", {}, false, function(source, args)
        local Player = PlayerModule.GetPlayerBySource(source)
        TriggerClientEvent('Ethnic-chat/client/post-message', source, "JOB: ", Player.PlayerData.Job.Label, "normal")
    end)

    CommandsModule.Add("login", "Log in", {}, false, function(source, args)
        TriggerClientEvent('Ethnic-base/client/on-login', source)
    end, "admin")

    CommandsModule.Add("logout", "Go to character selection", {}, false, function(source, args)
        PlayerModule.Logout(source)
        Citizen.Wait(450)
        TriggerClientEvent('Ethnic-ui/client/send-to-character-screen', source)
    end, "admin")

    -- [ Events ] --

    EventsModule.RegisterServer("Ethnic-ui/server/play-sound-on-entity", function(Source, Sound, Entity, Timeout)
        TriggerClientEvent('Ethnic-ui/client/playaudio-on-entity', Source, Sound, Entity, Timeout, math.random(111, 999))
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/play-sound-in-distance", function(Source, Data)
        ...
        TriggerClientEvent('Ethnic-ui/client/play-audio-at-pos', Source, Position, Data['Distance'], Data['Name'], Data['Volume'])
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/play-sound-at-pos", function(Source, Sound, Coords, Range, Volume)
        TriggerClientEvent('Ethnic-ui/client/play-audio-at-pos', Source, {[1] = Coords.x, [2] = Coords.y, [3] = Coords.z}, Range, Sound, Volume)
    end)

    -- [ Characters ] --

    EventsModule.RegisterServer("Ethnic-ui/server/create-character", function(Source, Data)
        local PlayerData = {}
        ...
        if PlayerModule.Login(Source, false, PlayerData) then
            ...
            TriggerClientEvent('Ethnic-clothing/client/create-new-char', Source)
        end
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/load-character", function(Source, Data)
        if PlayerModule.Login(Source, Data.Cid) then
            CommandsModule.Refresh(Source)
            TriggerClientEvent('Ethnic-spawn/client/open-spawn-selector', Source, false)
        end
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/delete-character", function(Source, Data)
        PlayerModule.DeleteCharacter(Source, Data.Cid)
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/characters/send-to-character-screen", function(Source)    
        local Player = PlayerModule.GetPlayerBySource(Source)
        if Player ~= nil then
            PlayerModule.Logout(Source)
            Citizen.Wait(450)
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/set-stress", function(Source, Type, Amount)
        local Player = PlayerModule.GetPlayerBySource(Source)
        local newStress
        if Player ~= nil then
            if Type == 'Remove' then
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-panic-button", function(Source, StreetLabel, Type)
        ...
        TriggerClientEvent('Ethnic-ui/client/send-emergency-alert', -1, AlertList[AlertId], false)
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/send-explosion", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
        ...
        TriggerClientEvent('Ethnic-ui/client/send-emergency-alert', -1, AlertList[AlertId], true)
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/send-stealing-vehicle", function(Source, StreetLabel, VehDesc)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-bank-monitor", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-bank-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-banktruck-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-bobcat-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-houses-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-jewelery-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-suspicious", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-store-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-pacific-rob", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-civ-injured", function(Source, StreetLabel)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-civ-alert", function(Source, StreetLabel, Data, Anonymous)
        local src = Source
        local AlertId = #AlertList + 1
        local Player = PlayerModule.GetPlayerBySource(src)
        AlertList[AlertId] = {
        ...
        TriggerClientEvent('Ethnic-ui/client/send-emergency-alert', -1, AlertList[AlertId], true, not Anonymous)
    end)

    EventsModule.RegisterServer("Ethnic-ui/server/send-hunting-illegal", function(Source, StreetLabel)
        local src = Source
        local AlertData = {}
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-fighting-progress", function(Source, StreetLabel, Melee)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-shooting-progress", function(Source, StreetLabel, IsInVehicle, VehDesc)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-boosting-alert", function(Source, StreetLabel, VehDesc)
        local src = Source
        local AlertId = #AlertList + 1
        AlertList[AlertId] = {
            ['AlertId'] = AlertId,
    ...
    EventsModule.RegisterServer("Ethnic-ui/server/send-911-call", function(Source, Data, StreetLabel, IsAnonymously)
        TriggerClientEvent('Ethnic-police/client/send-911', -1, Data, IsAnonymously)
    end)
end)
