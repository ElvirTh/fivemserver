...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/contacts/get-contacts', function(Source, Cb)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/contacts/get-contact', function(Source, Cb, Number)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    EventsModule.RegisterServer("Ethnic-phone/server/contacts/add-contact", function(Source, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
        DatabaseModule.Execute('SELECT * FROM player_phone_contacts WHERE citizenid = ?', {
            Player.PlayerData.CitizenId
        }, function(Contacts)
            ...
            TriggerClientEvent('Ethnic-phone/client/contacts/refresh', Source)
        end, true)
    end)
    
    EventsModule.RegisterServer("Ethnic-phone/server/contacts/remove-contact", function(Source, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    function AlreadyStoppedCall(ContactNumber, Caller)
        if Calls[ContactNumber] == nil then -- Check if already hung up.
            ...
            TriggerClientEvent('Ethnic-phone/client/hide-notification', Caller.PlayerData.Source, ContactNumber)
            return false
        end
    end
    ...
    EventsModule.RegisterServer('Ethnic-phone/server/dial-payphone', function(Source, Data)
        ...
        if RecData and Receiver then -- Check if online
            if Calls[Data.Phone] == nil then
                ...
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Caller.PlayerData.Source, Data.Phone)
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Receiver.PlayerData.Source, Data.Phone)
                TriggerClientEvent('Ethnic-phone/client/call/do-anim', Caller.PlayerData.Source)
                TriggerClientEvent('Ethnic-phone/client/set-call-data', Caller.PlayerData.Source, {
                    Payphone = true,
                    Id = Data.Phone,
                })
                ...
                TriggerClientEvent('Ethnic-phone/client/notification', Receiver.PlayerData.Source, {
                    ...
                    Buttons = {
                        {
                            ...
                            Event = "Ethnic-phone/client/call/force-disconnect",
                            EventData = true,
                            Tooltip = "Disconnect",
                            Color = "#f2a365",
                            CloseOnClick = false,
                        },
                        {
                            ...
                            Event = "Ethnic-phone/client/calling/answer-call",
            ...
            -- Do call sounds and stuff
                ...
                while Calls[Data.Phone] ~= nil and not Calls[Data.Phone].InCall do
                    ...
                    if Tries < 5 then
                        ...
                        TriggerClientEvent('Ethnic-ui/client/play-audio-at-pos', -1, {[1] = PlayerCoords.x, [2] = PlayerCoords.y, [3] = PlayerCoords.z}, 5.0, "phone-calling", 0.6)
                        TriggerClientEvent('Ethnic-ui/client/play-audio-at-pos', -1, {[1] = TargetCoords.x, [2] = TargetCoords.y, [3] = TargetCoords.z}, 5.0, "phone-ringing", 0.6)
                    else                            
                        TriggerClientEvent('Ethnic-phone/client/call/force-disconnect', Source, true)
                        TriggerClientEvent('Ethnic-phone/client/hide-notification', Source, Data.Phone..'-caller')
                        TriggerClientEvent('Ethnic-phone/client/hide-notification', Receiver.PlayerData.Source, Data.Phone..'-receiver')
                        Tries = 0
                        break
                    end
    ...
    EventsModule.RegisterServer("Ethnic-phone/server/contacts/call-contact", function(Source, Data)
        ...
        TriggerClientEvent('Ethnic-phone/client/notification', Caller.PlayerData.Source, {
        ...
        if RecData and Receiver then -- Check if online
            if Calls[Data.ContactData.number] == nil then
                ...
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Caller.PlayerData.Source, Data.ContactData.number)
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Receiver.PlayerData.Source, Data.ContactData.number)
                ...
                while Calls[Data.ContactData.number] ~= nil and not Calls[Data.ContactData.number].InCall do
                    ...
                    if Tries < 5 then
                        ...
                        TriggerClientEvent('Ethnic-phone/client/call/force-disconnect', Source)
                        TriggerClientEvent('Ethnic-phone/client/hide-notification', Source, Data.ContactData.number..'-caller')
                        TriggerClientEvent('Ethnic-phone/client/hide-notification', Receiver.PlayerData.Source, Data.ContactData.number..'-receiver')
                        Tries = 0
                        break
                    end
                    Citizen.Wait(RepeatTimeout)
                ...
                TriggerClientEvent('Ethnic-phone/client/notification', Source, {
                    Id = Data.ContactData.number,
                    Title = ReceiverName,
    ...
    EventsModule.RegisterServer("Ethnic-phone/server/calling/answer-call", function(Source, Data)
        ...
        if Caller and Receiver then
            ...
            if not Data.Declined then
                ...
                TriggerClientEvent('Ethnic-phone/client/set-notification-buttons', Receiver.PlayerData.Source, Data.Id..'-receiver', {
                    {
                        Icon = "fas fa-times-circle",
                        Event = "Ethnic-phone/client/call/force-disconnect",
                        Tooltip = "Disconnect",
                ...
                TriggerClientEvent('Ethnic-phone/client/contacts/set-call-thread', Caller.PlayerData.Source, true, Data.Id..'-caller')   
                TriggerClientEvent('Ethnic-phone/client/contacts/set-call-thread', Receiver.PlayerData.Source, true, Data.Id..'-receiver')
                TriggerClientEvent('Ethnic-phone/client/contacts/connect-voice', Caller.PlayerData.Source, true, Receiver.PlayerData.CharInfo.PhoneNumber, Receiver.PlayerData.Source)
            else 
                Calls[Data.Id] = nil
                TriggerClientEvent('Ethnic-phone/client/contacts/set-call-thread', Caller.PlayerData.Source, false, Data.Id..'-caller')
                TriggerClientEvent('Ethnic-phone/client/contacts/set-call-thread', Receiver.PlayerData.Source, false, Data.Id..'-receiver')
                TriggerClientEvent('Ethnic-phone/client/contacts/connect-voice', Caller.PlayerData.Source, false, Receiver.PlayerData.CharInfo.PhoneNumber)
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Caller.PlayerData.Source, nil)
                TriggerClientEvent('Ethnic-phone/client/set-call-id', Receiver.PlayerData.Source, nil)
                if IsPayphone then
                    TriggerClientEvent('Ethnic-phone/client/set-call-data', Caller.PlayerData.Source, false)
                end
                SetTimeout(1500, function()
                    TriggerClientEvent('Ethnic-phone/client/hide-notification', Caller.PlayerData.Source, Data.Id..'-caller')
                    TriggerClientEvent('Ethnic-phone/client/hide-notification', Receiver.PlayerData.Source, Data.Id..'-receiver')
                end)
            end
            ...
            if not IsPayphone then
                TriggerClientEvent('Ethnic-phone/client/calls/add-call-log', Caller.PlayerData.Source, CallLogReceiver)
            end
            TriggerClientEvent('Ethnic-phone/client/calls/add-call-log', Receiver.PlayerData.Source, CallLogSender)
        else
            TriggerClientEvent('Ethnic-phone/client/call/force-disconnect', Source, IsPayphone)
        end
    end)
end)