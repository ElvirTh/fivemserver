...
--                     TriggerClientEvent('Ethnic-casino/client/poker/update-state', -1, TableId, ServerPokers[TableId].Active, ServerPokers[TableId].TimeLeft)
--                     if ServerPokers[TableId].TimeLeft < 1 then
--                         if ServerPokers[TableId].Stage == 0 then
--                             Citizen.CreateThread(function()
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-1', -1, TableId) -- first ACTION
--                                 Citizen.Wait(9000)
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-2', -1, TableId) -- dealing PLAYER cards
...
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-3', -1, TableId) -- dealing DEALER cards
--                                 Citizen.Wait(8000)
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-4', -1, TableId) -- PLAYERS watching cards
--                                 Citizen.Wait((Config.Options['Poker']['PlayerDecideTime'] * 1000) + 5000)
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-5', -1, TableId) -- reveal PLAYER cards
--                                 local activePlayers = GetTablePlayersCount(TableId)
--                                 Citizen.Wait(2000 + (5000 * activePlayers))
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-6', -1, TableId) -- reveal DEALER cards
--                                 Citizen.Wait(10000)
--                                 CheckWinners(TableId) -- checking winners on server side
--                                 Citizen.Wait(1500)
--                                 TriggerClientEvent('Ethnic-casino/client/poker/set-stage-7', -1, TableId) -- clearing table
--                                 Citizen.Wait(8000 + (4000 * activePlayers))
--                                 TriggerClientEvent('Ethnic-casino/client/poker/reset-table', -1, TableId)
...
--             TriggerClientEvent('Ethnic-casino/client/poker/player-win', Source, TableId)
--         end
--     end
-- end
...
--         TriggerClientEvent('Ethnic-casino/client/poker/player-draw', Source, TableId)
--     end
-- end
...
--         TriggerClientEvent('Ethnic-casino/client/poker/player-lost', Source, TableId)
--     end
-- end
...
-- RegisterNetEvent('Ethnic-casino/server/poker/fold-cards', function(TableId)
--     local src = source
--     if ServerPokers[TableId] ~= nil then
--         ServerPokers[TableId].PlayersFolded[src] = true
--         TriggerClientEvent('Ethnic-casino/client/poker/player-fold-cards', -1, src, TableId)
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/server/poker/play-cards', function(TableId, BetAmount)
--     local src = source
--     local Player = PlayerModule.GetPlayerBySource(src)
--     if ServerPokers[TableId] ~= nil then
--         if Player.Functions.RemoveMoney('Casino', BetAmount, 'poker-play-cards') then
--             TriggerClientEvent('Ethnic-casino/client/poker/player-play-cards', -1, src, TableId)
--             local Chips = Player.PlayerData.Money['Casino']
--             TriggerClientEvent('Ethnic-casino/client/poker/update-player-chips', src, Chips)
--         else
...
-- RegisterNetEvent('Ethnic-casino/server/poker/stand-up', function(TableId, ChairId)
...
-- RegisterNetEvent('Ethnic-casino/server/poker/bet-pair-plus', function(TableId, BetAmount)
--     local src = source
--     local Player = PlayerModule.GetPlayerBySource(src)
--     local Chips = Player.PlayerData.Money['Casino']
--     if Player then
...
--                     TriggerClientEvent('Ethnic-casino/client/poker/player-pairplus-anim', Player.PlayerData.Source, BetAmount)
...
-- RegisterNetEvent('Ethnic-casino/server/poker/bet', function(TableId, ChairData, BetAmount)
--     local src = source
--     local Player = PlayerModule.GetPlayerBySource(src)
--     local Chips = Player.PlayerData.Money['Casino']
--     if Player then
...
--                     TriggerClientEvent('Ethnic-casino/client/poker/player-bet-anim', Player.PlayerData.src, BetAmount)
...
--                         }
--                     end
--                     TriggerClientEvent('Ethnic-casino/client/poker/update-cards', -1, TableId, ServerPokers[TableId].Cards)
--                 end
--             else
--                 Player.Functions.Notify('poker-already-bet', 'You already betted..', 'error')
--             end
...
--     CallbackModule.CreateCallback('Ethnic-casino/server/poker/can-sit', function(Source, Cb, TableId, ChairId)
--         local Player = PlayerModule.GetPlayerBySource(Source)
...
--             TriggerClientEvent('Ethnic-casino/client/poker/update-player-chips', Source, Chips)
--             Cb(true)
--         else
--             Cb(false)
--         end
