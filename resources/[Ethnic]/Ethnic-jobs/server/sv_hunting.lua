...
Citizen.CreateThread(function()
    ...
    EventsModule.RegisterServer("Ethnic-jobs/server/hunting/sell", function(Source)
        local Player = PlayerModule.GetPlayerBySource(Source)
        local CurrentTime = exports['Ethnic-weathersync']:GetCurrentTime()
    ...
    EventsModule.RegisterServer("Ethnic-jobs/server/hunting/receive-goods", function(Source, AnimalName, AnimalBait, Illegal, ItemBuff)
        local Player = PlayerModule.GetPlayerBySource(Source)
