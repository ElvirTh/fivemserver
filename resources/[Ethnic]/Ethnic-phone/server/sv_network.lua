...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/network/get-network-zones', function(Source, Cb)
        Cb(ServerConfig.Networks)
    end)

    CallbackModule.CreateCallback('Ethnic-phone/server/network/get-nearest-networks', function(Source, Cb, Zone)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/network/connect-to-network', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/vpn/get-vpn-data', function(Source, Cb, HasVPN)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/vpn/set-vpn-data', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
