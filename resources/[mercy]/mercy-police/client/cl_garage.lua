...
RegisterNetEvent('mercy-menu/client/open-pd-menu',function(CurrentPad)
    if CurrentPad == 'Police' then
        local MenuItems = {}
            ...
            MenuData['SecondMenu'] = {
                {
                    ...
                    ['Type'] = 'Click',
                    ['CloseMenu'] = true,
                    ['Data'] = { ['Event'] = 'mercy-police/client/take-out-pdvehicle', ['Type'] = 'Client', ['PoliceData'] = v },
                },
            }
            table.insert(MenuItems, MenuData)
        end 
...
RegisterNetEvent('mercy-police/client/take-out-pdvehicle',function(Data)
    local Player = PlayerModule.GetPlayerData
