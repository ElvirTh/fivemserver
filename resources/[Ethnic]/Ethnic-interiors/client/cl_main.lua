...
function CreateInterior(InteriorId, Coords, LoadProps)
	if not IsModelValid(InteriorId) then
        exports['Ethnic-ui']:SendUIMessage('Prompts', 'CreatePrompt', {
            color = 'error',
...
RegisterCommand("testInterior", function(Source, Args, Raw)
    exports['Ethnic-interiors']:DespawnInteriors()
    local Coords = GetEntityCoords(PlayerPedId())
    Coords = vector3(-1729.55, -2902.29, 13.94 - 35.0)
    local InteriorData = exports['Ethnic-interiors']:CreateInterior(Args[1], Coords, false)
