...
RegisterNetEvent("Ethnic-items/client/used-binoculars", function()
...
RegisterNetEvent("Ethnic-items/client/use-camera", function()
    if IsPedInAnyVehicle(PlayerPedId()) then return end
    Citizen.SetTimeout(500, function()
    ...
    Citizen.CreateThread(function()
        ...
        while DoingPDCamera do
            ...
            if GetGameTimer() > (LastUpdate + 1000) then
                ...
                local Hours, Minutes = exports['Ethnic-weathersync']:GetCurrentTime()
