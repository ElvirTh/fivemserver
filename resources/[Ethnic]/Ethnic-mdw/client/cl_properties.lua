RegisterNUICallback('MDW/Properties/GetProperties', function(Data, Cb)
    local Result = CallbackModule.SendCallback("Ethnic-mdw/server/properties/get")
    Cb(Result)
end)

RegisterNUICallback('MDW/Properties/LocateProperty', function(Data, Cb)
    local Result = CallbackModule.SendCallback("Ethnic-mdw/server/properties/get-data", Data)
