...
Citizen.CreateThread(function()
    ...
    EventsModule.RegisterServer("Ethnic-jobs/server/fishing-sell", function(Source)
    ...
    EventsModule.RegisterServer("Ethnic-jobs/server/fishing-receive-goods", function(Source, Type)
        local Player = PlayerModule.GetPlayerBySource(Source)
        if Type == 'Big' then
...
Citizen.CreateThread(function()
    while true do
        ...
        TriggerClientEvent('Ethnic-jobs/client/fishing/set-fishing-spot', -1, ServerConfig.CurrentFishSpot)
