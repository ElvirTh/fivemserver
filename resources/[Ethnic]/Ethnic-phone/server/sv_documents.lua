...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/get-by-citizenid', function(Source, Cb)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/new', function(Source, Cb, Data)
        -- Title, type 
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/get-data', function(Source, Cb, Data)
        -- DocumentId
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/get-by-type', function(Source, Cb, Data)
        -- Type
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/save', function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/documents/delete', function(Source, Cb, Data)
        -- DocumentId
...
RegisterNetEvent("Ethnic-phone/server/documents/share", function(Data)
    -- DocumentId
    local src = source
    ...
    DatabaseModule.Execute("SELECT * FROM player_phone_documents WHERE id = ?", {Data['DocumentId']}, function(Result)
        if Result[1] ~= nil then
            ...
            for k, v in pairs(Players) do
                ...
                TriggerClientEvent('Ethnic-phone/client/documents/refresh', TPlayer.PlayerData.Source)
