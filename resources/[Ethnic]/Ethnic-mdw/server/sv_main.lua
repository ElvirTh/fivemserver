...
Citizen.CreateThread(function() 
    ...
    CallbackModule.CreateCallback('Ethnic-mdw/server/get-user', function(Source, Cb, CitizenId)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/dashboard-create-announcement", function(Source, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/dashboard/get-announcements", function(Source, Cb)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/businesses/get", function(Source, Cb)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/businesses/get-employees", function(Source, Cb, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/evidence/create", function(Source, Data)
        -- Data.Id
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/evidence/update", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/evidence/assign", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/evidence/delete", function(Source, Data)
        DatabaseModule.Execute('DELETE FROM mdw_evidences WHERE id = ?', {
            Data.Id,
        })
    end)

    CallbackModule.CreateCallback("Ethnic-mdw/server/evidence/get-all", function(Source, Cb)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/evidence/get-data", function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/get-legislation", function(Source, Cb)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/create-legislation", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/update-legislation", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/delete-legislation", function(Source, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/get-profiles", function(Source, Cb)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/create-profile", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/update-profile", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/delete-profile", function(Source, Data)
        DatabaseModule.Execute('DELETE FROM mdw_profiles WHERE id = ?', {
            Data.Id,
        })
    end)

    CallbackModule.CreateCallback("Ethnic-mdw/server/profiles/request-profile", function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/profiles/request-data", function(Source, Cb, CitizenId, Id)
        local ProfileData = {
            ['Licenses']    = {},
            ['Vehicles']    = {},
            ['Housing']     = {},
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/add-profile-tag", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/remove-profile-tag", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/remove-profile-license", function(Source, Data)
        DatabaseModule.Execute('SELECT * FROM players WHERE CitizenId = ?', {
            Data.CitizenId
        }, function(PlayerData)
            if PlayerData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/profiles/get-warrants", function(Source, Cb)
        local Warrants = {}
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/properties/get", function(Source, Cb)
        local HouseList = {}
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/properties/get-data", function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/get-reports", function(Source, Cb)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/update-report", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/create-report", function(Source, Data)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/reports/get-data", function(Source, Cb, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/add-tag", function(Source, Data)
        -- Id, Tags
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/remove-tag", function(Source, Data)
        DatabaseModule.Execute('SELECT tags FROM mdw_reports WHERE id = ?', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/reports/add-criminal-scum", function(Source, Cb, Data)
        -- Id, ScumId
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ?', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/reports/delete-criminal-scum", function(Source, Cb, Data)
        -- Id, ScumId
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ?', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Scums = json.decode(ReportData[1].scums)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/save-scum-charges", function(Source, Data)
        -- Id, ScumId, Charges
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Scums = json.decode(ReportData[1].scums)
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/reports/get-scum-data", function(Source, Cb, Data)
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Scums = json.decode(ReportData[1].scums)
                for k, v in pairs(Scums) do
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/save-scum-data", function(Source, Data)
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Scums = json.decode(ReportData[1].scums)
                for k, v in pairs(Scums) do
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/set-reduction", function(Source, Data)
        -- Id, ScumId, Reduction
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Scums = json.decode(ReportData[1].scums)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/assign-officers", function(Source, Data)
        -- Id, Officers
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Officers = json.decode(ReportData[1].officers)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/remove-officer", function(Source, Data)
        -- Id, Officer
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
                local Officers = json.decode(ReportData[1].officers)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/remove-evidence", function(Source, Data)
        -- Id, Evidence
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/reports/search-scum", function(Source, Cb, Data)
        -- Query
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/reports/delete", function(Source, Data)
        -- Id
        DatabaseModule.Execute('SELECT * FROM mdw_reports WHERE id = ? ', {Data.Id}, function(ReportData)
            if ReportData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/get-staff-profiles", function(Source, Cb)
        DatabaseModule.Execute('SELECT * FROM mdw_staff', {}, function(StaffData)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/create-staff-profile", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/update-staff-profile", function(Source, Data)
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/delete-staff-profile", function(Source, Data)
        -- Id
        DatabaseModule.Execute('SELECT * FROM mdw_staff WHERE id = ? ', {Data.Id}, function(StaffData)
            if StaffData[1] ~= nil then
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/add-staff-profile-tag", function(Source, Data)
        -- Id, Tags
    ...
    EventsModule.RegisterServer("Ethnic-mdw/server/remove-staff-profile-tag", function(Source, Data)
        -- Id, Tag
        DatabaseModule.Execute('SELECT * FROM mdw_staff WHERE id = ? ', {Data.Id}, function(StaffData)
            if StaffData[1] ~= nil then
    ...
    CallbackModule.CreateCallback("Ethnic-mdw/server/staff/request-profile", function(Source, Cb, Data)
        -- CitizenId
