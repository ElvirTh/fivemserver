Config = {
    ...
    --[[
        ...
        AddEventHandler('Ethnic-pool:notification', function(serverId, message)
    ...
    --[[
        ...
        TriggerEvent('Ethnic-pool:setupTable', 'BALL_SETUP_STRAIGHT_POOL')
    ]]
    CustomMenu = true,
    ...
    --[[
        ...
        AddEventHandler('Ethnic-pool:payForPool', function(playerServerId, cb)
    ...
    --[[
        ...
        SERVERSIDE HANDLERS
            - Ethnic-pool:onReturnCue - called when player takes cue
            - Ethnic-pool:onTakeCue   - called when player returns cue

        CLIENTSIDE EVENTS
            - Ethnic-pool:takeCue   - forces player to take cue in hand
            - Ethnic-pool:removeCue - removes cue from player's hand
