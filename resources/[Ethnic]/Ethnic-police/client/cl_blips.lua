...
RegisterNetEvent('Ethnic-police/client/update-service-blips', function(BlipData)
...
RegisterNetEvent('Ethnic-police/client/clear-service-blips', function()
    RemoveAllJobBlips()
end)

RegisterNetEvent('Ethnic-police/client/remove-service-blip', function(ServerId)
    if not LocalPlayer.state.LoggedIn then return end
    if PlayerData == nil or PlayerData == false or PlayerData.Job == nil then return end
    if PlayerData.Job.Name ~= 'ems' and PlayerData.Job.Name ~= 'police' then return end
