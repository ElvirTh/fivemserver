...
CloseRadio = function() {
    $.post('https://Ethnic-ui/Radio/Close', JSON.stringify({}));
...
$(document).on('click', '.radio-button', function(e) {
    ...
    if (Type == 'on/off') {
        $.post('https://Ethnic-ui/Radio/Click', JSON.stringify({}));
        $.post('https://Ethnic-ui/Radio/TogglePower', JSON.stringify({}));
    } else if (Type == 'connect') {
        var ChannelToJoin = $('.radio-channel').val();
        $.post('https://Ethnic-ui/Radio/Click', JSON.stringify({}));
        $.post('https://Ethnic-ui/Radio/JoinRadio', JSON.stringify({Channel: ChannelToJoin}));
    } else if (Type == 'disconnect') {
        $.post('https://Ethnic-ui/Radio/Click', JSON.stringify({}));
        $.post('https://Ethnic-ui/Radio/LeaveRadio', JSON.stringify({}));
    }
});
