...
Config.Menu = {
    ...
    -- Always add below this.. because above data is being set.
    {
        ...
        Close = true,
        FunctionType = 'Client',
        FunctionName = 'mercy-menu/client/open-pd-menu',
        FunctionParameters = '',
        EnableMenu = function()
            if not exports['mercy-hospital']:IsDead() then
                if exports['mercy-police']:IsNearPolicePad() and PlayerData.Job.Name == 'police' and PlayerData.Job.Duty then
    ...
    },
    {
        ...
        Close = true,
        FunctionType = 'Client',
        FunctionName = 'mercy-menu/client/park-policeveh',
        FunctionParameters = '',
        EnableMenu = function()
            local Entity, EntityType = FunctionsModule.GetEntityPlayerIsLookingAt(5.5, 0.2, 286, PlayerPedId())
            if not exports['mercy-hospital']:IsDead() and (PlayerData.Job.Name == 'police' and exports['mercy-police']:IsNearPolicePad()) and PlayerData.Job.Duty and EntityType == 2 then
