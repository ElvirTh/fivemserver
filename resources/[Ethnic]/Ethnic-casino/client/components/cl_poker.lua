...
--                                                     exports['Ethnic-ui']:SetInteraction('[E] - Three Card Poker')
--                                                 end
...
-- RegisterNetEvent('Ethnic-casino/client/poker/player-pairplus-anim', function(Amount)
--     if SharedPokers[ActivePokerTable] ~= nil then
--         SharedPokers[ActivePokerTable].playerPairPlusAnim(Amount)
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/update-cards', function(TableId, Cards)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].updateCards(Cards)
--     end
-- end)
-- RegisterNetEvent('Ethnic-casino/client/poker/update-state', function(TableId, Active, TimeLeft)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].updateState(Active, TimeLeft)
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/player-bet-anim', function(Amount)
--     if SharedPokers[ActivePokerTable] ~= nil then
--         SharedPokers[ActivePokerTable].playerBetAnim(Amount)
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/update-player-chips', function(Amount)
--     PlayerOwnedChips = Amount
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/player-draw', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].playerDraw()
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/player-lost', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].playerLost()
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/player-win', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].playerWin()
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/reset-table', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].resetTable()
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-7', function(TableId)
--     if SharedPokers[TableId] ~= nil then
...
-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-6', function(TableId)
--     if SharedPokers[TableId] ~= nil then
...
-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-5', function(TableId)
--     if SharedPokers[TableId] ~= nil then
...
-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-1', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].FirstAction()
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-2', function(TableId)
--     if SharedPokers[TableId] ~= nil then
...
-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-3', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         currentHelpText = nil
...
-- RegisterNetEvent('Ethnic-casino/client/poker/set-stage-4', function(TableId)
--     if SharedPokers[TableId] ~= nil then
--         currentHelpText = nil
...
-- RegisterNetEvent('Ethnic-casino/client/poker/player-play-cards', function(Source, TableId)
--     if SharedPokers[TableId] ~= nil then
--         SharedPokers[TableId].playCards(Source)
--     end
-- end)

-- RegisterNetEvent('Ethnic-casino/client/poker/player-fold-cards', function(Source, TableId)
--     if SharedPokers[TableId] ~= nil then
...
--             local CanSit = CallbackModule.SendCallback('Ethnic-casino/server/poker/can-sit', self.index, ChairId)
--             if CanSit then
--                 ActiveChairData = {
--                     chairId = ChairId,
...
--                 Citizen.Wait(500)
--             else
--                 exports['Ethnic-ui']:Notify("seat-occupied-poker", "This seat is occupied.", 'error')
--             end
--         end
--     end
...
--                             ClientTimer = nil
--                             exports['Ethnic-ui']:Notify('poker-not-intime', 'You did not respond for the dealer ask in time, you have folded your hand.', 'error')
--                             TriggerServerEvent('Ethnic-casino/server/poker/fold-cards', self.index)
--                         end
--                     end
--                 end
--             end)
...
--                                 ButtonScaleform = nil
--                                 StopGameplayCamShaking(true)
--                                 TriggerServerEvent('Ethnic-casino/server/poker/play-cards', self.index, playerBetted)
--                             end
...
--                                         if playerBetted == nil then
--                                             TriggerServerEvent('Ethnic-casino/server/poker/bet', self.index, ActiveChairData, currentBetInput)
--                                         else
--                                             if playerPairPlus == nil then
--                                                 TriggerServerEvent('Ethnic-casino/server/poker/bet-pair-plus', self.index, currentBetInput)
--                                             end
--                                         end
--                                     else
--                                         PlaySoundFrontend(-1, 'DLC_VW_ERROR_MAX', 'dlc_vw_table_games_frontend_sounds', true)
--                                     end
--                                 else
--                                     exports['Ethnic-ui']:Notify("no-bet-input", "You didn\'t set a bet.", 'error')
--                                 end
--                             end
...
--             Citizen.Wait(4000)
--             TriggerServerEvent('Ethnic-casino/server/poker/stand-up', self.index, ActiveChairData.chairId)
