...
CloseContextMenu = function(DoCloseEvent) {
    $.post('https://Ethnic-ui/Context/CloseContext', JSON.stringify({}))
    if (DoCloseEvent) {
        ...
        if (TotalMenuData != null && TotalMenuData != undefined && TotalMenuData['CloseEvent'] != null && TotalMenuData['CloseEvent'] != undefined) {
            $.post('https://Ethnic-ui/Context/ContextEvent', JSON.stringify({MenuData: TotalMenuData['CloseEvent']}))
        }
    }
    HasContextOpen = false;
...
$(document).on('click', '.context-item', function(e) {
    ...
    if (CanClick) {
        ...
        if (MenuData['SecondMenu'] != null && MenuData['SecondMenu'] != undefined) {
            $.post('https://Ethnic-ui/Context/ContextEvent', JSON.stringify({MenuData: MenuData['Data']}))
            CanClick = false;
...
$(document).on('click', '.return', function(e) {
    ...
    if (CanClick) {
        ...
        if (TotalMenuData['ReturnEvent'] != null && TotalMenuData['ReturnEvent'] != undefined) {
            $.post('https://Ethnic-ui/Context/ContextEvent', JSON.stringify({MenuData: TotalMenuData['ReturnEvent']}))
        }
        GoBackToMainMenu()
    }
});
