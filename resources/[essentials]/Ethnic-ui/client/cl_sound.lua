...
RegisterNetEvent('Ethnic-ui/client/play-sound', function(AudioName, AudioVolume, Id)
...
RegisterNetEvent('Ethnic-ui/client/stop-sound', function(Id)
    SendUIMessage('Sounds', 'StopSound', {
        Id = Id,
    })
end)

RegisterNetEvent('Ethnic-ui/client/play-audio-at-pos', function(Position, MaxDistance, AudioName, AudioVolume, FallOff)
...
RegisterNetEvent('Ethnic-ui/client/playaudio-on-entity', function(SoundName, Entity, Timeout, Id, IsServerId, ServerId)
...
RegisterNetEvent('Ethnic-ui/client/stop-entity-sound', function(Id)
    if EntitySounds[Id] then
        StopSound(EntitySounds[Id])
        ReleaseSoundId(EntitySounds[Id])
        EntitySounds[Id] = nil
