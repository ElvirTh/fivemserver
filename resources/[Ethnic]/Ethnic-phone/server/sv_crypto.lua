...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/purchase-crypto', function(Source, Cb, Data)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/exchange-crypto', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
