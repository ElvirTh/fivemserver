...
AddEventHandler('Modules/server/ready', function()
    TriggerEvent('Modules/server/request-dependencies', {
        ...
        EventsModule.RegisterServer('Ethnic-chat/server/post-message', function(source, Title, Message, Class)
            TriggerClientEvent('Ethnic-chat/client/post-message', -1, Title, Message, Class)
        end)
    end)
end)
