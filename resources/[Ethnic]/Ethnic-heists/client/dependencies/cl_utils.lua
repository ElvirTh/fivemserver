...
RegisterNetEvent('Ethnic-heists/client/bomb-animation', function(Coords, Rotation)
...
RegisterNetEvent('Ethnic-heists/client/reset-bomb-animation', function(Coords, Rotation)
