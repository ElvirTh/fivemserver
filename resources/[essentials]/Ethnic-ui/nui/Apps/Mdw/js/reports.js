...
$(document).on('click', '.mdw-reports > .mdw-block-header > .mdw-block-header-icons > i', function(Event) {
    ...
    if (ClickType == 'Save') {
        if (MdwData.ReportData.EditingReport) {
            $.post('https://Ethnic-mdw/MDW/Reports/UpdateReport', JSON.stringify({
            ...
            $.post('https://Ethnic-mdw/MDW/Reports/CreateReport', JSON.stringify({
                Category: GetReportInputValue('Category'),
                Title: GetReportInputValue('Title'),
                Content: GetReportInputValue('Content'),
            }), function() {
        ...
        if (MdwData.ReportData.EditingReport) {
            $.post("https://Ethnic-mdw/MDW/Reports/Delete", JSON.stringify({
                Id: MdwData.ReportData.CurrentEditingData.id
            }), function(){
                DoMdwLoader(1300, function() {
                    LoadReports();
    ...
    if (Parent == "tags") {
        if (ClickType == 'Add') {
            ...
            DoMdwPicker('TagSearch', (Result) => {
                $.post('https://Ethnic-mdw/MDW/Reports/AddTags', JSON.stringify({
                    Id: MdwData.ReportData.CurrentEditingData.id,
                    Tags: Result,
                }), function() {
        ...
        DoMdwPicker('Profiles', function(e){            
            ...
            $.post("https://Ethnic-mdw/MDW/Reports/AddCriminalScum", JSON.stringify({
                Id: MdwData.ReportData.CurrentEditingData.id,
                ScumId: ScumId,
            }), function(Success){
                if (!Success) return;
        ...
        $.post('https://Ethnic-mdw/MDW/Staff/GetStaffProfiles', JSON.stringify({}), function(Profiles) {
            ...
            DoMdwPicker('TagSearch', (Result) => {
                $.post("https://Ethnic-mdw/MDW/Reports/AssignOfficers", JSON.stringify({
                    Id: MdwData.ReportData.CurrentEditingData.id,
                    Officers: Result,
                }), function(){
                    DoMdwLoader(1300, function() {
        ...
        DoMdwPicker('Evidence', (IsAssign, Data) => {
            if (!IsAssign) {
                $.post("https://Ethnic-mdw/MDW/Evidence/CreateEvidence", JSON.stringify({
                    Id: MdwData.ReportData.CurrentEditingData.id,
                    Data: Data,
                }), function(){
                    DoMdwLoader(1300, function() {
                ...
                $.post("https://Ethnic-mdw/MDW/Evidence/AssignEvidence", JSON.stringify({
                    Id: MdwData.ReportData.CurrentEditingData.id,
                    EvidenceId: Data.Id,
                }), function(){
                    DoMdwLoader(1300, function() {
...
$(document).on('click', '.block-three > .mdw-reports > #personsinvolved > .mdw-person-scum-container > .mdw-person-scum-icons > i', function(e){
    ...
    if (ClickType == 'Save') {
        ...
        $.post("https://Ethnic-mdw/MDW/Reports/SaveScumData", JSON.stringify({
            Id: MdwData.ReportData.CurrentEditingData.id,
        ...
        $.post("https://Ethnic-mdw/MDW/Reports/DeleteCriminalScum", JSON.stringify({
            Id: MdwData.ReportData.CurrentEditingData.id,
            ScumId: $(this).parent().parent().attr("data-scumId"),
        }), function(){
            DoMdwLoader(1300, function() {
...
$(document).on('click', '.block-three > .mdw-reports > #personsinvolved > .mdw-person-scum-container > .mdw-person-scum-reductions > .mdw-person-scum-reduction > input', function(e){
    ...
    $.post("https://Ethnic-mdw/MDW/Reports/GetScumData", JSON.stringify({
        Id: MdwData.ReportData.CurrentEditingData.id,
        ...
        let Reductions = [
            {
                ...
                Callback: () => {
                    ...
                    $.post("https://Ethnic-mdw/MDW/Reports/SetReduction", JSON.stringify({
                        Id: MdwData.ReportData.CurrentEditingData.id,
                        ScumId: Scum.attr("data-scumId"),
                        Reduction: 0,
                    }))
...
$(document).on('click', '.block-three > .mdw-reports > #personsinvolved > .mdw-person-scum-container > .mdw-person-scum-charges > #mdw-person-scum-edit-charges', function(e){
    ...
    $.post("https://Ethnic-mdw/MDW/Reports/GetScumData", JSON.stringify({
        ...
        DoMdwPicker('Charges', (Result) => {
            $.post("https://Ethnic-mdw/MDW/Reports/SaveScumCharges", JSON.stringify({
                Id: MdwData.ReportData.CurrentEditingData.id,
                ScumId: Scum.attr("data-scumId"),
                Charges: Result,
            }));
...
$(document).on('click', '.block-three > .mdw-reports > #tags > .mdw-information-data > .mdw-information-data-tag > i', function(Event) {
    ...
    $.post('https://Ethnic-mdw/MDW/Reports/RemoveTag', JSON.stringify({
        Id: MdwData.ReportData.CurrentEditingData.id,
        Tag: TagIndex,
    }), function() {
        DoMdwLoader(1300, function() {
...
$(document).on('click', '.block-three > .mdw-reports > #evidence > .mdw-information-data > .mdw-information-data-tag > i', function(Event) {
    ...
    $.post('https://Ethnic-mdw/MDW/Reports/RemoveEvidence', JSON.stringify({
        Id: MdwData.ReportData.CurrentEditingData.id,
...
$(document).on('click', '.block-three > .mdw-reports > #officersinvolved > .mdw-information-data > .mdw-information-data-tag > i', function(Event) {
    ...
    $.post("https://Ethnic-mdw/MDW/Reports/RemoveOfficer", JSON.stringify({
        Id: MdwData.ReportData.CurrentEditingData.id,
...
ClickedOnReport = async function(ReportData) {
    DoMdwLoader(250, function() {
        ...
        $.post('https://Ethnic-mdw/MDW/Reports/GetReportData', JSON.stringify({Id: ReportData.id}), function(Result) {
...
LoadReports = async (ReportId) => {
    ...
    $.post('https://Ethnic-mdw/MDW/Reports/GetReports', JSON.stringify({}), function(Reports) {
...
$(document).on('input', '.block-one > .mdw-reports > .mdw-block-header > .ui-styles-input > .ui-input-field', function(e) {
    ...
    $.post("https://Ethnic-mdw/MDW/Reports/SearchScum", JSON.stringify({
        Query: SearchText
    }), function(Result){
        ScumSearched = [];
