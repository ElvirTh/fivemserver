...
Citizen.CreateThread(function()
    for k, v in pairs(Cats) do
        if v.Interactable then
            exports['Ethnic-ui']:AddEyeEntry("uwu_cat_" .. k, {
                Type = 'Zone',
                SpriteDistance = 10.0,
                Distance = 1.75,
                ZoneData = {
                ...
                Options = {
                    {
                        ...
                        Label = 'Tickle Kitty',
                        EventType = 'Client',
                        EventName = 'Ethnic-misc/client/foodchain/uwu/pat',
                        EventParams = {},
                        Enabled = function(Entity)
                            -- local ClockedInEmployees = CallbackModule.SendCallback("Ethnic-business/server/get-clocked-in-employees", "UwU Café")
...
RegisterNetEvent('Ethnic-misc/client/foodchain/uwu/pat', function()
    ...
    for k,v in pairs(NearbyPeds) do
        ...
        if Distance < 2 then
            ...
            elseif CatCoords.z > 22 then
                TriggerEvent('Ethnic-animations/client/play-animation', "mechanic4")
            end
            ...
            EventsModule.TriggerServer('Ethnic-ui/server/set-stress', 'Remove', 100)
