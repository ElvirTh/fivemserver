            ...
            MenuData['SecondMenu'] = {
                {
                    ...
                    ['Type'] = 'Click',
                    ['Data'] = { ['Event'] = 'Ethnic-hospital/client/take-out-heli', ['Type'] = 'Client', ['HeliData'] = v },
                },
            }
...
RegisterNetEvent('Ethnic-hospital/client/take-out-heli', function(Data)
...
RegisterNetEvent('Ethnic-hospital/client/open-garage', function()
    local MenuItems = {}
        ...
        MenuData['SecondMenu'] = {
            {
                ...
                ['Data'] = {['Event'] = 'Ethnic-hospital/client/spawn-vehicle', ['Type'] = 'Client', ['Model'] = v.Model},
                ['CloseMenu'] = true,
            }
        }
        table.insert(MenuItems, MenuData)
...
RegisterNetEvent('Ethnic-hospital/client/spawn-vehicle', function(Data)
...
RegisterNetEvent('Ethnic-hospital/client/park-vehicle', function(Data)
