...
Citizen.CreateThread(function() 
    ...
    CallbackModule.CreateCallback('Ethnic-jobs/server/bees/get-config', function(Source, Cb)
        Cb(Config.BeeHives)
    end)

    CallbackModule.CreateCallback('Ethnic-jobs/server/fishing/get-current-spot', function(Source, Cb)
        Cb(ServerConfig.CurrentFishSpot)
    end)

    -- Receipts

    EventsModule.RegisterServer("Ethnic-jobs/server/sell-receipts", function(Source, Coords, Heading)
    ...
    CallbackModule.CreateCallback('Ethnic-jobs/server/get-job-locs', function(Source, Cb, Job, Leader)
        Cb(ServerConfig.JobLocations)
    end)

    EventsModule.RegisterServer("Ethnic-jobs/server/set-job-locs", function(Source, Job, Leader)
...
RegisterNetEvent("Ethnic-jobs/server/receive-paycheck", function()
    local src = source
