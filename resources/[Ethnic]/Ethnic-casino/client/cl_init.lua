...
Citizen.CreateThread(function()
    ...
    exports['Ethnic-ui']:AddEyeEntry("casino_wheel_ped", {
        Type = 'Entity',
        EntityType = 'Ped',
        SpriteDistance = 10.0,
        State = false,
    ...
    exports['Ethnic-ui']:AddEyeEntry("casino_chips2", {
        Type = 'Zone',
        SpriteDistance = 10.0,
        Distance = 5.0,
        ZoneData = {
        ...
        Options = {
            {
                ...
                Label = 'Interact',
                EventType = 'Client',
                EventName = 'Ethnic-casino/client/casino-actions',
                EventParams = {},
                Enabled = function(Entity)
                    return true
                end,
    ...
    exports['Ethnic-ui']:AddEyeEntry("room_rental_ped_right", {
        Type = 'Entity',
        EntityType = 'Ped',
        SpriteDistance = 10.0,
        Distance = 5.0,
...
RegisterNetEvent('Ethnic-polyzone/client/enter-polyzone', function(PolyData, Coords)
    ...
    if DoesRoomExist(PolyData.name) then
        ...
        exports['Ethnic-ui']:SetInteraction('[E] Storage', 'primary')
...
function StartRoomThread(PolyInfo)
    ...
    while InRoom do
        ...
        if IsControlJustReleased(0, 38) then
            exports['Ethnic-ui']:HideInteraction()
            local StorageFetch = exports['Ethnic-ui']:CreateInput({
                {
                    Name = 'password', 
            ...
            if StorageFetch['password'] then
                TriggerServerEvent('Ethnic-casino/server/fetch-storage', PolyInfo, StorageFetch['password'])
            end
        end
    end
end