...
Hud.onReady(() => {
    ...
    if (Water == undefined) Water = CreateHud('hud-thirst', 'rgb(2, 119, 189)', 'rgb(39, 55, 70,1.0)', 650); 
    if (Stress == undefined) Stress = CreateHud('hud-stress', 'rgb(213, 0, 0)', 'rgb(39, 55, 70,1.0)', 650);
    if (Oxy == undefined) Oxy = CreateHud('hud-oxy', 'rgb(144, 164, 174)', 'rgb(39, 55, 70,1.0)', 650);
    if (Nos == undefined) Nos = CreateHud('hud-nos', 'rgb(228, 63, 90)', 'rgb(39, 55, 70,1.0)', 650);
    if (Timer == undefined) Timer = CreateHud('hud-timer', 'rgb(146, 52, 235)', 'rgb(39, 55, 70,1.0)', 350);
    if (FireMode == undefined) FireMode = CreateHud('hud-firemode', 'rgb(255, 74, 104)', 'rgb(39, 55, 70,1.0)', 650);
    if (PursuitMode == undefined) PursuitMode = CreateHud('hud-pursuit', 'rgb(255, 74, 104)', 'rgb(39, 55, 70,1.0)', 650);
    if (DriftMode == undefined) DriftMode = CreateHud('hud-drift', 'rgb(189, 22, 189)', 'rgb(39, 55, 70,1.0)', 650);
    if (DevMode == undefined) DevMode = CreateHud('hud-devmode', 'rgb(39, 55, 70,1.0)', 'rgb(39, 55, 70,1.0)', 650);
        ...
        if (Key === 'Health') {
            ...
            if (CurrentHudValues.Health.Value != Value.Value && HudPreferences.ShowHealth) {
                ...
                if ((Value.Value - 100) <= 10) {
                    ...
                    Health.trail.setAttribute("stroke", "rgb(39, 55, 70,1.0)")
                }
            }
            ...
            if (Value.Value <= 10) {
                ...
                Armor.trail.setAttribute("stroke", "rgb(39, 55, 70,1.0)")
            }
            ...
            if (Value.Value <= 10) {
                ...
                Food.trail.setAttribute("stroke", "rgb(39, 55, 70,1.0)")
            }
            ...
            if (Value.Value <= 10) {
                ...
                Water.trail.setAttribute("stroke", "rgb(39, 55, 70,1.0)")
            }
            ...
            if (Value.OnRadio) {
                if ($('.hud-voice').find('i').hasClass('fas fa-microphone-alt')) {
                    $('.hud-voice').find('i').removeClass('fas fa-microphone-alt').addClass('fa-headset');
                }
            } else {
                if ($('.hud-voice').find('i').hasClass('fa-headset')) {
                    $('.hud-voice').find('i').removeClass('fa-headset').addClass('fas fa-microphone-alt');
                }
            }
...
Hud.addNuiListener('ToggleComponentActive', (Data) => {
    if (Data.Type == 'Voice') {
        if (Data.Bool) {
            ...
            Voice.path.setAttribute("stroke", "rgb(148, 153, 151)")
            Voice.trail.setAttribute("stroke", "rgba(39, 55, 70,1.0)")
        }
    }
})
...
Hud.addNuiListener('UpdateVehicleHud', (Data) => {
    ...
    if (Data.Fuel <= 10) {
        ...
        $('#hud-fuel__circle').attr("stroke", "rgb( 46, 204, 113)");
        $('#hud-fuel__bgCircle').attr("stroke", "rgb( 46, 204, 113)");
    }
