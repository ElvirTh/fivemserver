...
RegisterNetEvent('Ethnic-housing/client/remove-decoration-menu', function()
    if not InsideHouse then return exports['Ethnic-ui']:Notify("housing-error", "You must be inside a house to do this..", "error") end
    local MenuItems = {}
    ...
    for k, v in pairs(InsideHouseData.Decorations) do
        ...
        MenuData['Data'] = { ['Event'] = 'Ethnic-housing/client/select-furniture', ['Type'] = 'Client', ['DecorationId'] = k }
        MenuData['SecondMenu'] = {
            {
                ['Title'] = 'Delete Decoration',
                ['Type'] = 'Click',
                ['Data'] = { ['Event'] = 'Ethnic-housing/client/delete-furniture', ['Type'] = 'Client', ['DecorationId'] = k },
            },
        }
    ...
    exports['Ethnic-ui']:OpenContext({ ['MainMenuItems'] = MenuItems,
        ['ReturnEvent'] = {['Event'] = 'Ethnic-housing/client/unselect-furniture', ['Type'] = 'Client'}, 
        ['CloseEvent'] = {['Event'] = 'Ethnic-housing/client/unselect-furniture', ['Type'] = 'Client'}
    })
end)

RegisterNetEvent('Ethnic-housing/client/delete-furniture', function(Data)
    EventsModule.TriggerServer("Ethnic-housing/server/delete-decoration", Data.DecorationId, InsideHouseData.Name)
    SetTimeout(250, function()
        TriggerEvent('Ethnic-housing/client/remove-decoration-menu')
    end)
end)

RegisterNetEvent('Ethnic-housing/client/unselect-furniture', function(Data)
    HasFurnitureSelected = false
end)

RegisterNetEvent('Ethnic-housing/client/select-furniture', function(Data)
        ...
        Citizen.CreateThread(function()
            ...
            while HasFurnitureSelected do
                ...
                if Object == nil or not DoesEntityExist(Object) then
                    HasFurnitureSelected = false
                    exports['Ethnic-ui']:Notify("housing-error", "This decoration does not exist?", "error")
                end
...
RegisterNetEvent('Ethnic-housing/client/open-furniture', function(Data)
    OpenFurnitureMenu(Data)
end)

RegisterNetEvent('Ethnic-housing/client/open-furniture-category', function(Data)
    OpenFurnitureMenuCategory(Data)
end)

local PreviewObject = nil
RegisterNetEvent('Ethnic-housing/client/preview-furniture', function(Data)
...
RegisterNetEvent('Ethnic-housing/client/cancel-preview', function()
...
RegisterNetEvent('Ethnic-housing/client/place-furniture', function(Data)
    EntityModule.DoEntityPlacer(Data['Model'], 15.0, false, true, nil, function(DidPlace, Coords, Heading)
        if not DidPlace then
            TriggerEvent('Ethnic-housing/client/open-furniture', { HouseId = InsideHouseData.Name })
            return exports['Ethnic-ui']:Notify("housing-error", "You stopped placing this decoration, or something went wrong..", "error")
        end

        EventsModule.TriggerServer('Ethnic-housing/server/place-decoration', InsideHouseData.Name, Data['Model'], Coords, Heading)
...
function OpenFurnitureMenu(Data)
    if InsideHouseData == nil or InsideHouseData.Name ~= Data.HouseId then
        return exports['Ethnic-ui']:Notify("housing-error", "You have to be in that house if you want to decorate it..", "error")
    end
    ...
    Citizen.SetTimeout(250, function()
        ...
        for k, v in pairs(Config.EditorMenus) do
            ...
            MenuData['Data'] = { ['Event'] = 'Ethnic-housing/client/open-furniture-category', ['Type'] = 'Client', ['Category'] = v.Category }
            MenuData['Type'] = 'Click'
...
function OpenFurnitureMenuCategory(Data)
    Citizen.SetTimeout(250, function()
        ...
        MenuItems[1]['Data'] = { ['Event'] = 'Ethnic-housing/client/open-furniture', ['Type'] = 'Client', ['HouseId'] = InsideHouseData.Name }
        ...
        for k, v in pairs(Config.Decorations[Data.Category]) do
            ...
            MenuData['Title'] = v
            MenuData['Desc'] = ''
            MenuData['Data'] = { ['Event'] = 'Ethnic-housing/client/preview-furniture', ['Type'] = 'Client', ['Model'] = v }
            MenuData['SecondMenu'] = {
                {
                    ['Title'] = 'Place Decoration',
                    ['Type'] = 'Click',
                    ['Data'] = { ['Event'] = 'Ethnic-housing/client/place-furniture', ['Type'] = 'Client', ['Model'] = v },
                },
            }
            table.insert(MenuItems, MenuData)
        end
        ...
        exports['Ethnic-ui']:OpenContext({ ['MainMenuItems'] = MenuItems, 
            ['ReturnEvent'] = {['Event'] = 'Ethnic-housing/client/cancel-furniture', ['Type'] = 'Client'}, 
            ['CloseEvent'] = {['Event'] = 'Ethnic-housing/client/cancel-preview', ['Type'] = 'Client'}
        })
    end)
end
