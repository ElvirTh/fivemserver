    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://Ethnic-phone/Cameras/AddCamera", JSON.stringify({
...
$(document).on('click', '.phone-cameras-item #phone-cameras-view', function(e){
    ...
    $.post("https://Ethnic-phone/Cameras/ViewCamera", JSON.stringify({
        CamId: CamId,
    }));
});
...
$(document).on('click', '.phone-cameras-item #phone-cameras-delete', function(e){
    $('.tooltip-css').remove();
    var CamId = JSON.parse($(this).parent().parent().parent().attr("CamId"));
    $.post("https://Ethnic-phone/Cameras/DeleteCamera", JSON.stringify({
        CamId: CamId,
    }));
