local InsideMeetingRoom, PodiumActive, NearHeliPad, NearPolicePad, ShowingInteraction = false, false, false, false
local NearJail, IsNearGarage, NearReclaim = false, false, false
local CurrentMeetingRoom = "police_meeting"

function InitZones()
    Citizen.CreateThread(function()
        exports['Ethnic-ui']:AddEyeEntry("police_check_in", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.5,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Duty Options',
                    EventType = 'Client',
                    EventName = 'Ethnic-base/client/duty-menu',
                    EventParams = {},
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_locker", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Police Locker',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-police-store',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_personal_locker", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-police-locker',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'police' and Player.Job.Duty then
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_trash", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Trashcan',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-police-trash',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry(GetHashKey("p_planning_board_02"), {
            Type = 'Model',
            ...
            Options = {
                {
                    ...
                    Label = 'Change URL',
                    EventType = 'Client',
                    EventName = 'Ethnic-assets/client/change-dui-url',
                    EventParams = "police",
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_evidence_stash_1", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-police-evidence',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'police' and Player.Job.Duty then
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_evidence_stash_2", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 1.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_stash_high", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Employee List',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-employee-list',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                ...
                },
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-police-command-stash',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'police' and Player.Job.Duty and Player.Job.HighCommand then
                ...
                },
                {
                    ...
                    Label = 'Create Badge',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/create-badge',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'police' and Player.Job.Duty and Player.Job.HighCommand then
                ...
                },
                {
                    ...
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/try-purchase-vehicle',
                    EventParams = {},
                    Enabled = function(Entity)
                        local Player = exports['Ethnic-base']:FetchModule('Player').GetPlayerData()
                        if Player.Job.Name == 'police' and Player.Job.Duty and Player.Job.HighCommand then
        ...
        -- VCPD
        exports['Ethnic-ui']:AddEyeEntry("police_check_in_vcpd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_evidence_stash_vcpd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.5,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_personal_locker_vcpd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_locker_vcpd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_stash_high_vcpd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        -- SYPD
        exports['Ethnic-ui']:AddEyeEntry("police_check_in_sypd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 4.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_evidence_stash_sypd", {
            Type = 'Zone',
            SpriteDistance = 3.5,
            Distance = 1.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_personal_locker_sypd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_locker_sypd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.5,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("police_stash_high_sypd", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.5,
            ZoneData = {
        ...
        -- Jail
        exports['Ethnic-ui']:AddEyeEntry(GetHashKey('p_phonebox_02_s'), {
            Type = 'Model',
            ...
            Options = {
                {
                    ...
                    Label = 'Check Time',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/check-jail-time',
                    EventParams = '',
                    Enabled = function(Entity)
                        if exports['Ethnic-police']:IsInJail() then
                            return true
                        else
                            return false
                        end
                ...
                },
                {
                    ...
                    Label = 'Sleep (Logout)',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/go-to-jail-sleep',
                    EventParams = '',
                    Enabled = function(Entity)
                        if exports['Ethnic-police']:IsInJail() then
                            return true
                ...
                },
                {
                    ...
                    Label = 'Change Job',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/change-task',
                    EventParams = '',
                    Enabled = function(Entity)
                        if exports['Ethnic-police']:IsInJail() and PlayerModule.GetPlayerData().MetaData['Jail'] > 1 then
                            return true
                        end
                        return false
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_hole", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 2.5,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Escape Jail',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/escape-jail',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_craft", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.5,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = '????',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/open-jail-craft',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_slushy", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Tap a Slushy!',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/jail-tap-slushy',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_food", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Take A Plate!',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/jail-take-late',
                    EventParams = {},
                    Enabled = function(Entity)
                        return true
                    end,
        ...
        -- Jail Jobs
        -- Prison Tasks
        exports['Ethnic-ui']:AddEyeEntry("jail_task_stack_bricks", {
            Type = 'Zone',
            SpriteDistance = 5.0,
            Distance = 3.0,
            ZoneData = {
            ...
            Options = {
                {
                    ...
                    Label = 'Stack Stones',
                    EventType = 'Client',
                    EventName = 'Ethnic-police/client/do-prison-task',
                    EventParams = { Task = 'Scrapyard', Job = 'StackBricks' },
                    Enabled = function(Entity)
                        if not exports['Ethnic-police']:IsInJail() then return false end
                        local Task = exports['Ethnic-police']:GetPrisonJob().Task
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_sort_scrap", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 7.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_deliver_scrap", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 7.0,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_sort_kitchen", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 1.5,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_01", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_02", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_03", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_04", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_05", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_06", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_07", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
        ...
        exports['Ethnic-ui']:AddEyeEntry("jail_task_clean_table_08", {
            Type = 'Zone',
            SpriteDistance = 10.0,
            Distance = 2.3,
            ZoneData = {
...
RegisterNetEvent('Ethnic-polyzone/client/enter-polyzone', function(PolyData, Coords)
    if PolyData.name == 'police_meeting' or PolyData.name == 'police_meeting_2' then
        if not InsideMeetingRoom then
            ...
            local DuiData = exports['Ethnic-assets']:GenerateNewDui('https://i.imgur.com/5Ust2GQ.jpg', 1920, 1080, CurrentMeetingRoom)
            if DuiData == false then
                local SecondDuiData = exports['Ethnic-assets']:GetDuiData(CurrentMeetingRoom)
                AddReplaceTexture('prop_planning_b1', 'prop_base_white_01b', SecondDuiData['TxdDictName'], SecondDuiData['TxdName'])
                exports['Ethnic-assets']:ActivateDui(CurrentMeetingRoom)
            else
    ...
    elseif PolyData.name == 'police_podium' then
        ...
        TriggerServerEvent("Ethnic-voice/server/transmission-state", 'Podium', true)
        TriggerEvent('Ethnic-voice/client/proximity-override', "Podium", 3, 15.0, 2)
        PodiumActive = true
    ...
    elseif PolyData.name == 'police_helipad' then
        ...
        if not ShowingInteraction then
            ...
            exports['Ethnic-ui']:SetInteraction('Helipad', 'primary')
        end
    elseif PolyData.name == 'gov_policepad' then
        NearPolicePad = true
        if not ShowingInteraction then
            ShowingInteraction = true
            exports['Ethnic-ui']:SetInteraction('PoliceGarage', 'primary')
        end
    /*elseif PolyData.name == 'police_garage' then
        IsNearGarage, CurrentGarage = true, 'MRPD'
        if not ShowingInteraction then
           ShowingInteraction = true
            exports['Ethnic-ui']:SetInteraction('Parking', 'primary')
    end*/
    ...
    elseif PolyData.name == 'jail_reclaim' or PolyData.name == 'police_jail_stuff' then
        if not NearReclaim then
            ...
            if not ShowingInteraction then
                ShowingInteraction = true
                exports['Ethnic-ui']:SetInteraction('[E] Reclaim', 'primary')
            end
            while NearReclaim do
                ...
                if IsControlJustReleased(0, 38) then
                    ...
                    if exports['Ethnic-inventory']:CanOpenInventory() then
                        ...
                        EventsModule.TriggerServer('Ethnic-inventory/server/open-other-inventory', "jail-"..MyStateId, 'Stash', 45, 0.0)
                    end
                end
            end
        end
...
RegisterNetEvent('Ethnic-polyzone/client/leave-polyzone', function(PolyData, Coords)
    if PolyData.name == 'police_meeting' or PolyData.name == 'police_meeting_2' then
        if InsideMeetingRoom then
            ...
            exports['Ethnic-assets']:ReleaseDui(CurrentMeetingRoom)
        end
    elseif PolyData.name == 'jail_zone' then
        NearJail = false
    elseif PolyData.name == 'police_podium' then
        if not PodiumActive then return end
        TriggerServerEvent("Ethnic-voice/server/transmission-state", 'Podium', false)
        TriggerEvent('Ethnic-voice/client/proximity-override', "Podium", 3, -1, -1)
        PodiumActive = false
    elseif PolyData.name == 'police_helipad' then
        NearHeliPad = false
...
function IsNearPolicePad()
    return NearPolicePad
end
exports('IsNearPolicePad', IsNearPolicePad)
