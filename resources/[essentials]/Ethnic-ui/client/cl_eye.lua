...
function GetNearestEntries()
    ...
    local Entity = exports['Ethnic-base']:FetchModule("Entity")
    ...
    for k, v in pairs(Eye.Entries) do
        ...
        elseif v.Type:lower() == 'model' or v.Type:lower() == 'default' then
            ...
            local Logger = exports['Ethnic-base']:FetchModule("Logger")
...
-- [ Examples \\
--[[
exports['Ethnic-ui']:AddEyeEntry("ped_1", {
    Type = 'Entity',
    ...
    Options = {
        {
            ...
            EventType = 'Client',
            EventName = 'Ethnic-ui:Client:EyeTest',
            EventParams = {},
...
exports['Ethnic-ui']:AddEyeEntry("object_1", {
    Type = 'Entity',
    Entity = Entity,  -- Optional, use only when the entity is spawned by script
    SpriteDistance = 10.0,
    Distance = 5.0,
...
exports['Ethnic-ui']:AddEyeEntry("zone_1", {
    Type = 'Zone',
    SpriteDistance = 10.0,
    Distance = 5.0,
    State = false,
...
exports['Ethnic-ui']:AddEyeEntry(GetHashKey("prop_bin_05a"), {
    Type = 'Model',
    Model = 'prop_bin_05a',
    SpriteDistance = 10.0,
    Distance = 5.0,
