var Config = {
    ...
    ProfileTags: {
        ...
        1: {Text: 'DOJ (Department of Justice)', Color: '#6d32a8'},
        2: {Text: 'BCSO (Blaine County Sheriff\'s Office)', Color: '#a88332'},
        3: {Text: 'LSPD (Los Santos Police Department)', Color: '#326fa8'},
        4: {Text: 'Government', Color: '#3242a8'},
        5: {Text: 'Terrorist', Color: '#c22929'},
        6: {Text: 'Deceased', Color: '#781919'},
        7: {Text: 'DNA On File', Color: '#77e362'},
        8: {Text: 'Weapon License Removed', Color: '#c93e3e'}
    },
    StaffTags: {
    ...
    Reports: {
        ...
        Tags: {
            0: {Text: 'Gang Related', Color: '#c93e3e'},
            1: {Text: 'Terrorism', Color: '#c22929'},
            2: {Text: 'Firearm Sales', Color: '#c22929'},
            3: {Text: 'Illegal Substance Sales', Color: '#c22929'},
            4: {Text: 'Fraud', Color: 'white'},
            5: {Text: 'Theft', Color: 'white'},
        },
