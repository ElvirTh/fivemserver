...
RegisterNetEvent("Ethnic-assets/client/toggle-items", function(Bool)
...
RegisterNetEvent("Ethnic-assets/client/attach-items", function()
	...
	for k, v in pairs(Config.AttachBackProps) do
		if exports['Ethnic-inventory']:HasEnoughOfItem(v.Id, 1) and not IsPropOnBack(v.Model) then
