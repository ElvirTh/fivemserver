        ...
        ['Options'] ={
            {
                ...
                ['Label'] = "Pass Over",
                ['EventType'] = "Client",
                ['EventName'] = "Ethnic-illegal/client/sell",
                ['EventParams'] = {
                    ['Type'] = "weed-bag", -- This is the item name
                },
                Enabled = function(Entity)
                    return exports["Ethnic-inventory"]:HasEnoughOfItem("weed-bag", 1) -- Edit this if changing Sell Amount
                end,
            }
        },
    },
        ...
        ['Options'] ={
            {
                ...
                Enabled = function(Entity)
                    return exports["Ethnic-inventory"]:HasEnoughOfItem("cash-rolls", 5) -- Edit this if changing Sell Amount
                end,
            }
        },
    },
