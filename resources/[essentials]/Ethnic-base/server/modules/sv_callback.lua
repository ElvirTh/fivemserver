...
CallbackModule = {
    TriggerCallback = function(Name, Cb, ...)
        ...
        local src = source
        TriggerClientEvent("Ethnic-base/client/callbacks-client-trigger", src, CbId, Name, ...)
    end,
...
-- Client Callbacks
RegisterNetEvent("Ethnic-base/server/callbacks-client-response", function(Id, Data)
    local src = source
    TriggerClientEvent('Ethnic-base/client/callbacks-client-response', src, Id, Data)
end)

-- Server callbacks
RegisterNetEvent("Ethnic-base/server/callbacks-trigger", function(Id, Name, ...)
    ...
    RegisteredCallbacks[Name](src, function(Data)
        TriggerClientEvent("Ethnic-base/client/callbacks-response", src, Id, Data)
    end, ...)
end)