...
RegisterNetEvent('Ethnic-assets/client/do-jail-intro', function(Name, Months, Parole, Cid, Date)
    if not GoingToJail then
        GoingToJail = true
        DoScreenFadeOut(10)

        FreezeEntityPosition(PlayerPedId(), true)
        TriggerEvent('Ethnic-police/client/reset-cuffed')
        TriggerEvent('Ethnic-ui/client/play-sound', 'handcuff', 0.4)
        ...
        TriggerEvent('Ethnic-ui/client/play-sound', 'jail-photo', 0.4)
        Citizen.Wait(3000) 
        TriggerEvent('Ethnic-ui/client/play-sound', 'jail-photo', 0.4)
        Citizen.Wait(3000) 
        ...
        TriggerEvent('Ethnic-police/client/enter-jail', Months, Parole, false)
        ResetMugshot()
        GoingToJail = false
    end
end)
