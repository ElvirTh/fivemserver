...
Citizen.CreateThread(function()
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/debts/get', function(Source, Cb)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/debts/pay', function(Source, Cb, Data)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    CallbackModule.CreateCallback('Ethnic-phone/server/get-overdue-debts', function(Source, Cb, Category)
        local Player = PlayerModule.GetPlayerBySource(Source)
    ...
    EventsModule.RegisterServer('Ethnic-phone/server/debts/add', function(Source, StateId, Title, Amount, ExpireInDays)
        local Player = PlayerModule.GetPlayerBySource(Source)
