...
Phone.addNuiListener("SetPhoneNetwork", Data => {
    ...
    if (PhoneData.Network == 'old_bennys') {
        ...
        if (PhoneData.Network == 'None') {
            $.post("https://Ethnic-phone/Network/Disconnect", JSON.stringify({}));
...
$(document).on({
    keydown: function(e) {
        ...
        switch(e.keyCode){
            case 27: // ESC
                $('.tooltip-css').remove();
                $.post("https://Ethnic-phone/ClosePhone");
                break;
        }
    },
});
...
Phone.onReady(() => {
    ...
    //                 Event: "Ethnic-phone/client/jobs/accept-invite",
    ...
    //                 Event: "Ethnic-phone/client/jobs/reject-invite",
...
$(document).on("click", ".phone-topbar-network", function(e){
    ...
    if ($(this).css('opacity', '0.5')) {
        ...
        $.post("https://Ethnic-phone/Network/GetNetworks", JSON.stringify({}), function(Result){
            ...
            [
                ...
                },
                {
                    ...
                    Callback: (Result) => {
                        ...
                        $.post("https://Ethnic-phone/Network/Connect", JSON.stringify({
                            Data: Result,
...
$(document).on("click", ".phone-topbar-vpn", function(e){
    ...
    $.post("https://Ethnic-phone/Vpn/GetVPNData", JSON.stringify({}), function(Result){
        if (!Result) {
            return Notification({
                Title: "Thor",
            ...
            [
                ...
                },
                {
                    ...
                    Callback: (Result) => {
                        ...
                        $.post("https://Ethnic-phone/Vpn/SetVPNData", JSON.stringify({
                            Username: Result
                        }), function(Success){
                            SetPhoneLoader(false);
                            if (Success) {
...
$(document).on("click", ".phone-bottombar-photo", function(e){
    e.preventDefault();
    $.post("https://Ethnic-phone/SelfieMode", JSON.stringify({}))
});
...
$(document).on("click", ".phone-app", function(e){
    ...
    setTimeout(() => {
        $.post("https://Ethnic-phone/AppClick", JSON.stringify({
            App: $(this).attr("data-apptype")
        }));
    }, 20);
});
...
$(document).on("click", ".phone-notification .phone-notification-extra i", function(e){
    ...
    if (Event != undefined && Event.length > 0) {
        $.post("https://Ethnic-phone/Notifications/ButtonClick", JSON.stringify({
            Event: Event,
            EventType: EventType,
