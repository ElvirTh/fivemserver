    ...
    [
        ...
        },
        {
            ...
            Callback: (Result) => {
                ...
                $.post("https://Ethnic-phone/Documents/NewDocument", JSON.stringify({
                    Result: Result
                }), function(Document){
...
$(document).on('click', '.phone-documents-item', function(e){
    ...
    $.post("https://Ethnic-phone/Documents/GetDocumentData", JSON.stringify({
    ...
    BuildDropdown([
        {
            ...
            Callback: () => {
                $.post("https://Ethnic-phone/Documents/ShareLocal", JSON.stringify({
        ...
        },
        {
            ...
            Icon: 'fas fa-save',
            Callback: () => {
                $.post("https://Ethnic-phone/Documents/Save", JSON.stringify({
                    DocumentId: CurrentDocument,
        ...
        },
        {
            ...
            Callback: () => {
                $('.phone-documents-document').hide();
                $.post("https://Ethnic-phone/Documents/Delete", JSON.stringify({
                    DocumentId: CurrentDocument
                }), function(){
                    RefreshDocumentsItems();
                    $('.phone-documents-list').show();
...
function RefreshDocumentsItems(){
    ...
    $.post("https://Ethnic-phone/Documents/GetDocumentsByType", JSON.stringify({
        Type: Type,
    }), function(Documents){
        $(".phone-documents-items").empty();
