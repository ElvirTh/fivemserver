...
CallbackModule = {
    TriggerCallback = function(Name, Cb, ...)
        ...
        TriggerServerEvent("Ethnic-base/server/callbacks-trigger", CbId, Name, ...)
    end,
...
-- Server Callbacks
RegisterNetEvent("Ethnic-base/client/callbacks-response", function(Id, Data)
...
-- Client Callbacks
RegisterNetEvent("Ethnic-base/client/callbacks-client-response", function(Id, Data)
...
RegisterNetEvent("Ethnic-base/client/callbacks-client-trigger", function(Id, Name, ...)
    if not RegisteredClientCallbacks[Name] then return end
    RegisteredClientCallbacks[Name](function(Data)
        TriggerServerEvent("Ethnic-base/server/callbacks-client-response", Id, Data)
    end, ...)
end)