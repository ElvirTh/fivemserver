...
$(document).on('click', '.spawn-hover .spawn-button', function(e){
    $.post("https://Ethnic-ui/Spawn/SelectSpawn", JSON.stringify({
...
$(document).on({
    ...
    contextmenu: function(e){
        ...
        $.post("https://Ethnic-ui/Spawn/Favorite", JSON.stringify({
            Id: $(this).attr("data-id"),
    ...
    mouseenter: function(e){
        ...
        // if ($(this).attr("data-parent") == 'none') {
            ...
            //     $.post("https://Ethnic-ui/Spawn/GetHouseData", JSON.stringify({
            //         Id: $(this).attr("data-id"),
            //     }), function(Result){
            ...
            //     return;
            // }
            $.post("https://Ethnic-ui/Spawn/GetSpawnData", JSON.stringify({
                Id: $(this).attr("data-id"),
            }), function(Result){
                $('.spawn-hover').html(`<p>${Result.Name}</p>`);
            });
