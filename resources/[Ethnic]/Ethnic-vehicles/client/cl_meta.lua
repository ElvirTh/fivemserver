function LoadVehicleMeta(Vehicle, Data)
    TriggerServerEvent("Ethnic-vehicles/server/load-veh-meta", VehToNet(Vehicle), Data)
end

function SetVehicleMeta(Vehicle, Key, Value)
    TriggerServerEvent("Ethnic-vehicles/server/set-veh-meta", VehToNet(Vehicle), Key, Value)
end
