...
CreateThread(function()
    ...
    KeybindsModule.Add('switchPursuit', 'Vehicle', 'Switch Pursuit Modes', '', function(OnPress)
        ...
        TriggerEvent('Ethnic-ui/client/set-hud-values', 'PursuitMode', 'Value', CurrentPursuit)
        exports['Ethnic-ui']:Notify('pursuit', "Pursuit mode: "..CurrentPursuit:upper())
...
RegisterNetEvent("Ethnic-threads/entered-vehicle", function() 
    ...
    TriggerEvent('Ethnic-ui/client/set-hud-values', 'PursuitMode', 'Value', CurrentPursuit)
    TriggerEvent('Ethnic-ui/client/set-hud-values', 'PursuitMode', 'Show', true)
    SetPursuitMode(Vehicle)
end)
...
RegisterNetEvent("Ethnic-threads/exited-vehicle", function() 
    ...
    TriggerEvent('Ethnic-ui/client/set-hud-values', 'PursuitMode', 'Value', 'B')
    TriggerEvent('Ethnic-ui/client/set-hud-values', 'PursuitMode', 'Show', false)
    CurrentPursuit, PursuitNumber = 'B', 1
end)
